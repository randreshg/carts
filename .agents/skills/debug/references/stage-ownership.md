...
|---|---|
| `openmp-to-arts` | Did OpenMP structure become the right EDT/for/barrier shape? |
| `pattern-pipeline` | Did semantic pattern discovery or loop transforms distort the intended access pattern? |
