...
| Tensor/linalg as optimization substrate | MLIR linalg/tensor ecosystem | Implemented | `RaiseToLinalg`, `RaiseToTensor`, and `Tiling` now perform real SDE-stage transformations on supported subsets rather than only classification. |
