...
|---|---|---|---|---|
| [`sde`](./sde/README.md) | Source semantic plan: MU/CU/SU, patterns, tokens, barriers. | Source legality, memref access, dependence, reductions, pattern facts. | Tiling, fusion, chunking, distribution intent, barrier planning, reduction strategy. | OpenMP/Polygeist to SDE, SDE to CODIR. |
