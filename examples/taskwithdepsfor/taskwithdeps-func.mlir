...
[convert-arts-to-funcs] Lowering arts.datablock: %2 = arts.datablock "inout", %alloca : memref<100xf64>[%c0] [%c100] [f64, %c8] -> memref<100xf64>
[convert-arts-to-funcs] Lowering arts.datablock: %4 = arts.datablock "inout", %alloca_0 : memref<100xf64>[%c0] [%c100] [f64, %c8] -> memref<100xf64>
[convert-arts-to-funcs] Lowering arts.datablock: %14 = arts.datablock "out", %4 : memref<?xmemref<?xi8>>[%arg0] [%c1] [f64, %c8] -> memref<1xf64> {baseIsDb, isLoad}
[convert-arts-to-funcs] Lowering arts.datablock: %19 = arts.datablock "in", %4 : memref<?xmemref<?xi8>>[%18] [%c1] [f64, %c8] -> memref<1xf64> {baseIsDb, isLoad}
[convert-arts-to-funcs] Lowering arts.datablock: %21 = arts.datablock "out", %2 : memref<?xmemref<?xi8>>[%arg0] [%c1] [f64, %c8] -> memref<1xf64> {baseIsDb, isLoad}
[convert-arts-to-funcs] Lowering arts.datablock: %23 = arts.datablock "in", %4 : memref<?xmemref<?xi8>>[%arg0] [%c1] [f64, %c8] -> memref<1xf64> {baseIsDb, isLoad}
  ...
  func.func @compute() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    arts.edt dependencies(%2, %3) : (memref<?xmemref<?xi8>>, memref<?xmemref<?xi8>>) attributes {parallel} {
      ...
      arts.edt attributes {single} {
        %8 = arts.datablock_size %3 : memref<?xmemref<?xi8>> -> index
        %9 = arts.event %8 {grouped} : memref<100xi64>
        %10 = arith.sitofp %1 : i32 to f64
        scf.for %arg0 = %c0 to %c100 step %c1 {
          %11 = arith.index_cast %arg0 : index to i32
          %12 = arts.datablock "out", %3 : memref<?xmemref<?xi8>>[%arg0] [%c1] [f64, %c8] -> memref<?xi8> {baseIsDb, isLoad}
          ...
          %16 = arts.datablock "in", %3 : memref<?xmemref<?xi8>>[%15] [%c1] [f64, %c8] -> memref<?xi8> {baseIsDb, isLoad}
          %17 = arts.datablock "out", %2 : memref<?xmemref<?xi8>>[%arg0] [%c1] [f64, %c8] -> memref<?xi8> {baseIsDb, isLoad}
          %18 = arts.datablock "in", %3 : memref<?xmemref<?xi8>>[%arg0] [%c1] [f64, %c8] -> memref<?xi8> {baseIsDb, isLoad}
          %19 = memref.load %9[%15] : memref<100xi64>
          arts.edt dependencies(%16, %17, %18) : (memref<?xi8>, memref<?xi8>, memref<?xi8>), events(%19, %c-1_i32, %13) : (i64, i32, i64) {
            %20 = "polygeist.memref2pointer"(%18) : (memref<?xi8>) -> !llvm.ptr
            %21 = llvm.load %20 : !llvm.ptr -> f64
            %22 = "polygeist.memref2pointer"(%16) : (memref<?xi8>) -> !llvm.ptr
            %23 = llvm.load %22 : !llvm.ptr -> f64
            %24 = arith.cmpi sgt, %11, %c0_i32 : i32
            %25 = arith.select %24, %23, %cst : f64
            %26 = arith.addf %21, %25 : f64
            %27 = "polygeist.memref2pointer"(%17) : (memref<?xi8>) -> !llvm.ptr
