...
[convert-arts-to-funcs] Lowering arts.datablock
[arts-codegen] Base is a datablock: %5 = arts.datablock "out", %alloca_10 : memref<?xmemref<?xi8>>[%arg4] [%c1] [f64, %c8] -> memref<?xi8> {isPtrDb, isLoad}
[convert-arts-to-funcs] Lowering arts.edt
-----------------------------------------
[arts-codegen] Rewiring single datablock: %26 = "arts.datablock"(%20, %1, %arg4, %2) <{elementType = f64, mode = "out", operandSegmentSizes = array<i32: 1, 1, 1, 1>}> {isPtrDb, isLoad} : (memref<?xmemref<?xi8>>, index, index, index) -> memref<?xi8>
[convert-arts-to-funcs] Lowering arts.datablock
[arts-codegen] Base is a datablock: %45 = "arts.datablock"(%20, %1, %arg4, %2) <{elementType = f64, mode = "in", operandSegmentSizes = array<i32: 1, 1, 1, 1>}> {isPtrDb, isLoad} : (memref<?xmemref<?xi8>>, index, index, index) -> memref<?xi8>
[convert-arts-to-funcs] Lowering arts.datablock
[arts-codegen] Base is a datablock: %49 = "arts.datablock"(%20, %1, %48, %2) <{elementType = f64, mode = "in", operandSegmentSizes = array<i32: 1, 1, 1, 1>}> {isPtrDb, isLoad} : (memref<?xmemref<?xi8>>, index, index, index) -> memref<?xi8>
[convert-arts-to-funcs] Lowering arts.datablock
[arts-codegen] Base is a datablock: %51 = "arts.datablock"(%15, %1, %arg4, %2) <{elementType = f64, mode = "out", operandSegmentSizes = array<i32: 1, 1, 1, 1>}> {isPtrDb, isLoad} : (memref<?xmemref<?xi8>>, index, index, index) -> memref<?xi8>
[convert-arts-to-funcs] Lowering arts.edt
-----------------------------------------
[arts-codegen] Rewiring single datablock: %49 = "arts.datablock"(%20, %1, %48, %2) <{elementType = f64, mode = "in", operandSegmentSizes = array<i32: 1, 1, 1, 1>}> {isPtrDb, isLoad} : (memref<?xmemref<?xi8>>, index, index, index) -> memref<?xi8>
[arts-codegen] Rewiring single datablock: %51 = "arts.datablock"(%15, %1, %arg4, %2) <{elementType = f64, mode = "out", operandSegmentSizes = array<i32: 1, 1, 1, 1>}> {isPtrDb, isLoad} : (memref<?xmemref<?xi8>>, index, index, index) -> memref<?xi8>
[arts-codegen] Rewiring single datablock: %45 = "arts.datablock"(%20, %1, %arg4, %2) <{elementType = f64, mode = "in", operandSegmentSizes = array<i32: 1, 1, 1, 1>}> {isPtrDb, isLoad} : (memref<?xmemref<?xi8>>, index, index, index) -> memref<?xi8>
