      ...
      omp.master {
        ...
        scf.for %arg3 = %c0 to %6 step %c1 {
          ...
          omp.task   depend(taskdependout -> %alloca : memref<f64>) {
            %15 = arith.sitofp %8 : i32 to f64
            %16 = arith.addf %15, %7 : f64
            memref.store %16, %alloc[%arg3] : memref<?xf64>
            omp.terminator
          }
          %10 = memref.load %alloc[%arg3] : memref<?xf64>
          affine.store %10, %alloca_1[] : memref<f64>
          %11 = arith.addi %8, %c-1_i32 : i32
          %12 = arith.index_cast %11 : i32 to index
          %13 = memref.load %alloc[%12] : memref<?xf64>
          affine.store %13, %alloca_2[] : memref<f64>
          %14 = memref.load %alloc_0[%arg3] : memref<?xf64>
          affine.store %14, %alloca_3[] : memref<f64>
          omp.task   depend(taskdependin -> %alloca_1 : memref<f64>, taskdependin -> %alloca_2 : memref<f64>, taskdependout -> %alloca_3 : memref<f64>) {
            %15 = arith.cmpi sgt, %8, %c0_i32 : i32
            scf.if %15 {
              %16 = arith.addf %10, %13 : f64
              memref.store %16, %alloc_0[%arg3] : memref<?xf64>
            } else {
              memref.store %10, %alloc_0[%arg3] : memref<?xf64>
            }
            omp.terminator
          }
        }
