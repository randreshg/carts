...
-----------------------------------------
Rewiring uses of:
  %14 = arts.datablock "out" ptr[%alloca_0 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=affine_map<(d0, d1) -> (d0, d1)> {isLoad} -> memref<1x1xf64>
    - affine.store %13, %alloca_0[%arg0, %arg1] : memref<100x100xf64>
  New indices count: 0
  Updated indices count: 2
  Updated affine map: (d0, d1) -> (d0, d1)
  Updated: affine.store %13, %14[%c0, %c0] : memref<1x1xf64>
-----------------------------------------
Rewiring uses of:
  %12 = arts.datablock "out" ptr[%alloca : memref<100x100xf64>], offsets[%arg0], sizes[%c1, %c100], type[f64], typeSize[%c8], affineMap=affine_map<(d0) -> (0, d0)> {isLoad} -> memref<1x100xf64>
    - affine.store %13, %alloca[0, %arg0] : memref<100x100xf64>
  New indices count: 0
  Updated indices count: 2
  Updated affine map: (d0, d1) -> (d0, d1)
  Updated: affine.store %13, %12[%c0, %c0] : memref<1x100xf64>
-----------------------------------------
Rewiring uses of:
  %11 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], offsets[%arg0], sizes[%c1, %c100], type[f64], typeSize[%c8], affineMap=affine_map<(d0) -> (0, d0)> {isLoad} -> memref<1x100xf64>
    - %13 = affine.load %alloca_0[0, %arg0] : memref<100x100xf64>
  New indices count: 0
  Updated indices count: 2
  Updated affine map: (d0, d1) -> (d0, d1)
  Updated: %13 = affine.load %11[%c0, %c0] : memref<1x100xf64>
-----------------------------------------
Rewiring uses of:
  %12 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=affine_map<(d0, d1) -> (d0 - 1, d1)> {isLoad} -> memref<1x1xf64>
    - %14 = affine.load %alloca_0[%arg0 - 1, %arg1] : memref<100x100xf64>
  New indices count: 0
  Updated indices count: 2
  Updated affine map: (d0, d1) -> (d0, d1)
  Updated: %14 = affine.load %12[%c0, %c0] : memref<1x1xf64>
-----------------------------------------
Rewiring uses of:
  %13 = arts.datablock "out" ptr[%alloca : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=affine_map<(d0, d1) -> (d0, d1)> {isLoad} -> memref<1x1xf64>
    - affine.store %16, %alloca[%arg0, %arg1] : memref<100x100xf64>
  New indices count: 0
  Updated indices count: 2
  Updated affine map: (d0, d1) -> (d0, d1)
  Updated: affine.store %16, %13[%c0_1, %c0_1] : memref<1x1xf64>
-----------------------------------------
Rewiring uses of:
  %11 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=affine_map<(d0, d1) -> (d0, d1)> {isLoad} -> memref<1x1xf64>
    - %15 = affine.load %alloca_0[%arg0, %arg1] : memref<100x100xf64>
  New indices count: 0
  Updated indices count: 2
  Updated affine map: (d0, d1) -> (d0, d1)
  Updated: %15 = affine.load %11[%c0_1, %c0_1] : memref<1x1xf64>
-----------------------------------------
Rewiring uses of:
  ...
  func.func @compute() attributes {llvm.linkage = #llvm.linkage<external>} {
      ...
      arts.edt attributes {single} {
        ...
        affine.for %arg0 = 0 to 100 {
          ...
          affine.for %arg1 = 0 to 100 {
            %14 = arts.datablock "out" ptr[%1 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=#map {isLoad} -> memref<1x1xf64>
            arts.edt dependencies(%14) : (memref<1x1xf64>) {
              %c0 = arith.constant 0 : index
              affine.store %13, %14[%c0, %c0] : memref<1x1xf64>
              arts.yield
            }
          }
        }
        affine.for %arg0 = 0 to 100 {
          %11 = arts.datablock "in" ptr[%1 : memref<100x100xf64>], offsets[%arg0], sizes[%c1, %c100], type[f64], typeSize[%c8], affineMap=#map1 {isLoad} -> memref<1x100xf64>
          %12 = arts.datablock "out" ptr[%0 : memref<100x100xf64>], offsets[%arg0], sizes[%c1, %c100], type[f64], typeSize[%c8], affineMap=#map1 {isLoad} -> memref<1x100xf64>
          arts.edt dependencies(%12, %11) : (memref<1x100xf64>, memref<1x100xf64>) {
            %c0 = arith.constant 0 : index
            %13 = affine.load %11[%c0, %c0] : memref<1x100xf64>
            affine.store %13, %12[%c0, %c0] : memref<1x100xf64>
            arts.yield
          }
        }
        affine.for %arg0 = 1 to 100 {
          affine.for %arg1 = 0 to 100 {
            %11 = arts.datablock "in" ptr[%1 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=#map {isLoad} -> memref<1x1xf64>
            %12 = arts.datablock "in" ptr[%1 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=#map2 {isLoad} -> memref<1x1xf64>
            %13 = arts.datablock "out" ptr[%0 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=#map {isLoad} -> memref<1x1xf64>
            arts.edt dependencies(%12, %13, %11) : (memref<1x1xf64>, memref<1x1xf64>, memref<1x1xf64>) {
              %c0 = arith.constant 0 : index
              %14 = affine.load %12[%c0, %c0] : memref<1x1xf64>
              %15 = affine.load %11[%c0, %c0] : memref<1x1xf64>
              %16 = arith.addf %15, %14 : f64
              affine.store %16, %13[%c0, %c0] : memref<1x1xf64>
              arts.yield
            }
          }
        }
    ...
    affine.for %arg0 = 0 to 100 {
      ...
      affine.for %arg1 = 0 to 100 {
        ...
        %13 = affine.load %1[%arg0, %arg1] : memref<100x100xf64>
    ...
    affine.for %arg0 = 0 to 100 {
      ...
      affine.for %arg1 = 0 to 100 {
        %12 = arith.index_cast %arg1 : index to i32
        %13 = affine.load %0[%arg0, %arg1] : memref<100x100xf64>
