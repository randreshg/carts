  ...
  func.func @compute() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    arts.edt dependencies(%0, %1) : (memref<100x100xf64>, memref<100x100xf64>) attributes {parallel} {
      ...
      arts.edt attributes {single} {
        ...
        affine.for %arg0 = 0 to 100 {
          %11 = affine.load %alloca_0[0, %arg0] : memref<100x100xf64>
          %12 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], offsets[%arg0], sizes[%c1, %c100], type[f64], typeSize[%c8], affineMap=affine_map<(d0) -> (0, d0)> {isLoad} -> memref<1x100xf64>
          %13 = arts.datablock "out" ptr[%alloca : memref<100x100xf64>], offsets[%arg0], sizes[%c1, %c100], type[f64], typeSize[%c8], affineMap=affine_map<(d0) -> (0, d0)> {isLoad} -> memref<1x100xf64>
          arts.edt dependencies(%12, %13) : (memref<1x100xf64>, memref<1x100xf64>) {
            affine.store %11, %alloca[0, %arg0] : memref<100x100xf64>
            arts.yield
          }
        }
        affine.for %arg0 = 1 to 100 {
          affine.for %arg1 = 0 to 100 {
            ...
            %12 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=affine_map<(d0, d1) -> (d0, d1)> {isLoad} -> memref<1x1xf64>
            %13 = affine.load %alloca_0[%arg0 - 1, %arg1] : memref<100x100xf64>
            %14 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=affine_map<(d0, d1) -> (d0 - 1, d1)> {isLoad} -> memref<1x1xf64>
            %15 = arts.datablock "out" ptr[%alloca : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=affine_map<(d0, d1) -> (d0, d1)> {isLoad} -> memref<1x1xf64>
            arts.edt dependencies(%14, %15, %12) : (memref<1x1xf64>, memref<1x1xf64>, memref<1x1xf64>) {
              %16 = arith.addf %11, %13 : f64
    ...
    arts.edt dependencies(%0, %1) : (memref<100x100xf64>, memref<100x100xf64>) attributes {parallel} {
      ...
      arts.edt attributes {single} {
        ...
        affine.for %arg0 = 0 to 100 {
          ...
          %13 = arts.datablock "out" ptr[%alloca : memref<100x100xf64>], offsets[%arg0], sizes[%c1, %c100], type[f64], typeSize[%c8], affineMap=#map1 {isLoad} -> memref<1x100xf64>
          arts.edt dependencies(%12, %13) : (memref<1x100xf64>, memref<1x100xf64>) {
            affine.store %11, %alloca[0, %arg0] : memref<100x100xf64>
            arts.yield
          }
        ...
        affine.for %arg0 = 1 to 100 {
          affine.for %arg1 = 0 to 100 {
            %11 = affine.load %alloca_0[%arg0, %arg1] : memref<100x100xf64>
            %12 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=#map {isLoad} -> memref<1x1xf64>
            %13 = affine.load %alloca_0[%arg0 - 1, %arg1] : memref<100x100xf64>
            %14 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=#map2 {isLoad} -> memref<1x1xf64>
            %15 = arts.datablock "out" ptr[%alloca : memref<100x100xf64>], offsets[%arg0, %arg1], sizes[%c1, %c1], type[f64], typeSize[%c8], affineMap=#map {isLoad} -> memref<1x1xf64>
            arts.edt dependencies(%14, %15, %12) : (memref<1x1xf64>, memref<1x1xf64>, memref<1x1xf64>) {
              %16 = arith.addf %11, %13 : f64
              affine.store %16, %alloca[%arg0, %arg1] : memref<100x100xf64>
              arts.yield
