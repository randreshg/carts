...
-----------------------------------------
Depend clause: in -> %3 = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<f64>
    - Memref: <block argument> of type 'memref<?xf64>' at index: 1
    - Value: %8 = "affine.load"(%arg1, %arg3) <{map = affine_map<(d0) -> (d0)>}> : (memref<?xf64>, index) -> f64
    - AffineMap: affine_map<(d0) -> (d0)>
Depend clause: in -> %4 = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<f64>
    - Memref: <block argument> of type 'memref<?xf64>' at index: 1
    - Value: %9 = "affine.load"(%arg1, %arg3) <{map = affine_map<(d0) -> (d0 - 1)>}> : (memref<?xf64>, index) -> f64
    - AffineMap: affine_map<(d0) -> (d0 - 1)>
Depend clause: out -> %5 = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<f64>
    - Memref: <block argument> of type 'memref<?xf64>' at index: 2
    - Value: %10 = "affine.load"(%arg2, %arg3) <{map = affine_map<(d0) -> (d0)>}> : (memref<?xf64>, index) -> f64
    - AffineMap: affine_map<(d0) -> (d0)>
Depend clause: out -> %2 = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<f64>
    - Memref: <block argument> of type 'memref<?xf64>' at index: 1
    - Value: %7 = "affine.load"(%arg1, %arg3) <{map = affine_map<(d0) -> (d0)>}> : (memref<?xf64>, index) -> f64
    - AffineMap: affine_map<(d0) -> (d0)>
-----------------------------------------
  ...
  func.func @compute(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    arts.parallel {
      ...
      arts.single {
        affine.for %arg3 = 0 to %0 {
          %1 = arith.index_cast %arg3 : index to i32
          %2 = arts.make_dep "out", %arg1 : memref<?xf64>, #map() : !arts.dep
          arts.edt parameters(%1, %arg3) : i32, index, dependencies(%2) : !arts.dep {
            %6 = arith.sitofp %1 : i32 to f64
            affine.store %6, %arg1[%arg3] : memref<?xf64>
          }
          %3 = arts.make_dep "in", %arg1 : memref<?xf64>, #map() : !arts.dep
          %4 = arts.make_dep "in", %arg1 : memref<?xf64>, #map1() : !arts.dep
          %5 = arts.make_dep "out", %arg2 : memref<?xf64>, #map() : !arts.dep
          arts.edt parameters(%arg3, %cst) : index, f64, dependencies(%3, %4, %5) : !arts.dep, !arts.dep, !arts.dep {
            %6 = affine.load %arg1[%arg3] : memref<?xf64>
