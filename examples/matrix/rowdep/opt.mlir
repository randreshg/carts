OVERVIEW: CARTS Driver
Available Dialects: affine, arith, arts, builtin, cf, dlti, func, llvm, math, memref, omp, polygeist, scf
USAGE: carts-opt [options] <input file>
...
General options:
  ...
  Compiler passes to run
    ...
    =sibling                                           -   Perform only sibling fusion
      ...
      --convert-arts-to-llvm                                 -   Convert ARTS Dialec to LLVM Dialect
      ...
      --convert-openmp-to-arts                               -   Convert OpenMP functions to ARTS
      ...
      --create-datablocks                                    -   Identify Datablocks in the program
      --create-events                                        -   Analyzes the program and creates ARTS events
      --cse                                                  -   Eliminate common sub-expressions
      --datablock                                            -   Using the Datablock Analysis, perform changes to the DataBlock operations and optimize them if the user wants to
      --detect-reduction                                     -   Detect reductions in affine.for
      --edt                                                  -   Using the EDT Analysis, perform changes to the EDT operations and optimize them if the user wants to
