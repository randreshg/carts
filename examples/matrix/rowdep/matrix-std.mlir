    ...
    omp.parallel   {
      ...
      omp.master {
        ...
        scf.for %arg0 = %c0 to %c100 step %c1 {
          ...
          memref.store %14, %alloca_4[] : memref<f64>
        ...
        %11 = memref.load %alloca_0[%c0_5, %c0_6] : memref<100x100xf64>
        %alloca_7 = memref.alloca() : memref<f64>
        memref.store %11, %alloca_7[] : memref<f64>
        %c0_8 = arith.constant 0 : index
        %c0_9 = arith.constant 0 : index
        %12 = memref.load %alloca[%c0_8, %c0_9] : memref<100x100xf64>
        %alloca_10 = memref.alloca() : memref<f64>
        memref.store %12, %alloca_10[] : memref<f64>
        omp.task   depend(taskdependin -> %alloca_7 : memref<f64>, taskdependout -> %alloca_10 : memref<f64>) {
          scf.for %arg0 = %c0 to %c100 step %c1 {
        ...
        scf.for %arg0 = %c1 to %c100 step %c1 {
          ...
          memref.store %17, %alloca_2[] : memref<f64>
