module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @compute() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %alloca_4 = memref.alloca() : memref<100x100xf64>
    %1 = arts.datablock "inout" ptr[%alloca_4 : memref<100x100xf64>], indices[], sizes[%c100, %c100], type[f64], typeSize[%c8] -> memref<100x100xf64>
    %2 = call @rand() : () -> i32
    ...
    arts.edt dependencies(%0, %1) : (memref<100x100xf64>, memref<100x100xf64>) attributes {parallel} {
      ...
      arts.edt attributes {single} {
        ...
        affine.for %arg0 = 0 to 100 {
          ...
          %16 = arts.datablock "out" ptr[%alloca_4 : memref<100x100xf64>], indices[%arg0, %c0_3], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
          arts.edt dependencies(%16) : (memref<1x1xf64>) {
            %17 = arith.sitofp %15 : i32 to f64
            %18 = arith.addf %17, %12 : f64
            affine.for %arg1 = 0 to 100 {
              affine.store %18, %alloca_4[%arg0, %arg1] : memref<100x100xf64>
            }
            arts.yield
          }
        }
        %13 = arts.datablock "in" ptr[%alloca_4 : memref<100x100xf64>], indices[%c0_3, %c0_3], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
        %14 = arts.datablock "out" ptr[%alloca : memref<100x100xf64>], indices[%c0_3, %c0_3], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
        arts.edt dependencies(%14, %13) : (memref<1x1xf64>, memref<1x1xf64>) {
          affine.for %arg0 = 0 to 100 {
            %15 = affine.load %alloca_4[0, %arg0] : memref<100x100xf64>
        ...
        affine.for %arg0 = 1 to 100 {
          %15 = arith.index_cast %arg0 : index to i32
          %16 = arts.datablock "in" ptr[%alloca_4 : memref<100x100xf64>], indices[%arg0, %c0_3], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
          %17 = arith.addi %15, %c-1_i32 : i32
          %18 = arith.index_cast %17 : i32 to index
          %19 = arts.datablock "in" ptr[%alloca_4 : memref<100x100xf64>], indices[%18, %c0_3], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
          %20 = arts.datablock "out" ptr[%alloca : memref<100x100xf64>], indices[%arg0, %c0_3], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
          arts.edt dependencies(%20, %16, %19) : (memref<1x1xf64>, memref<1x1xf64>, memref<1x1xf64>) {
            affine.for %arg1 = 0 to 100 {
              %21 = affine.load %alloca_4[%arg0, %arg1] : memref<100x100xf64>
              %22 = affine.load %alloca_4[%arg0 - 1, %arg1] : memref<100x100xf64>
    ...
    %alloc = memref.alloc() : memref<100x100xf64, 1>
    %alloc_5 = memref.alloc() : memref<1xi32>
    affine.dma_start %alloca_4[%c0_1, %c0_1], %alloc[%c0_1, %c0_1], %alloc_5[%c0_1], %c10000_0 : memref<100x100xf64>, memref<100x100xf64, 1>, memref<1xi32>
    affine.dma_wait %alloc_5[%c0_1], %c10000_0 : memref<1xi32>
    affine.for %arg0 = 0 to 100 {
      %12 = arith.index_cast %arg0 : index to i32
      affine.for %arg1 = 0 to 100 {
        %14 = arith.index_cast %arg1 : index to i32
        %15 = affine.load %alloc[%arg0, %arg1] : memref<100x100xf64, 1>
    ...
    memref.dealloc %alloc : memref<100x100xf64, 1>
    ...
    %alloc_6 = memref.alloc() : memref<100x100xf64, 1>
    %alloc_7 = memref.alloc() : memref<1xi32>
    affine.dma_start %alloca[%c0, %c0], %alloc_6[%c0, %c0], %alloc_7[%c0], %c10000 : memref<100x100xf64>, memref<100x100xf64, 1>, memref<1xi32>
    affine.dma_wait %alloc_7[%c0], %c10000 : memref<1xi32>
    affine.for %arg0 = 0 to 100 {
      %12 = arith.index_cast %arg0 : index to i32
      affine.for %arg1 = 0 to 100 {
        %14 = arith.index_cast %arg1 : index to i32
        %15 = affine.load %alloc_6[%arg0, %arg1] : memref<100x100xf64, 1>
    ...
    memref.dealloc %alloc_6 : memref<100x100xf64, 1>
    return
  }
