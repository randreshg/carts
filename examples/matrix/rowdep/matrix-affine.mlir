  ...
  func.func @compute() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    arts.edt dependencies(%2, %3) : (memref<100x100xf64>, memref<100x100xf64>) attributes {task} {
      ...
      affine.for %arg0 = 0 to 100 {
        ...
        arts.edt dependencies(%14) : (memref<100xf64>) attributes {task} {
          ...
          affine.for %arg1 = 0 to 100 {
            affine.store %16, %14[%arg1] : memref<100xf64>
          }
          arts.yield
        }
      }
      ...
      arts.edt dependencies(%11, %12) : (memref<100xf64>, memref<100xf64>) attributes {task} {
        affine.for %arg0 = 0 to 100 {
          %13 = affine.load %11[%arg0] : memref<100xf64>
          affine.store %13, %12[%arg0] : memref<100xf64>
        }
        arts.yield
      }
      affine.for %arg0 = 1 to 100 {
        ...
        arts.edt dependencies(%16, %17, %18) : (memref<100xf64>, memref<100xf64>, memref<100xf64>) attributes {task} {
          affine.for %arg1 = 0 to 100 {
            %19 = affine.load %18[%arg1] : memref<100xf64>
            %20 = affine.load %16[%arg1] : memref<100xf64>
            %21 = arith.addf %19, %20 : f64
            affine.store %21, %17[%arg1] : memref<100xf64>
          }
          arts.yield
        }
      }
    ...
    affine.for %arg0 = 0 to 100 {
      ...
      affine.for %arg1 = 0 to 100 {
        ...
        %13 = affine.load %2[%arg0, %arg1] : memref<100x100xf64>
    ...
    affine.for %arg0 = 0 to 100 {
      ...
      affine.for %arg1 = 0 to 100 {
        %12 = arith.index_cast %arg1 : index to i32
        %13 = affine.load %3[%arg0, %arg1] : memref<100x100xf64>
