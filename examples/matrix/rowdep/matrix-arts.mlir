    ...
    arts.edt dependencies(%1, %0) : (memref<100x100xf64>, memref<100x100xf64>) attributes {parallel} {
      ...
      arts.edt attributes {single} {
        ...
        scf.for %arg0 = %c0 to %c100 step %c1 {
          ...
          %14 = arts.datablock "out" ptr[%alloca_0 : memref<100x100xf64>], indices[%arg0, %c0], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
        ...
        %11 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], indices[%c0, %c0], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
        %12 = arts.datablock "out" ptr[%alloca : memref<100x100xf64>], indices[%c0, %c0], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
        arts.edt dependencies(%11, %12) : (memref<1x1xf64>, memref<1x1xf64>) {
          scf.for %arg0 = %c0 to %c100 step %c1 {
        ...
        scf.for %arg0 = %c1 to %c100 step %c1 {
          %13 = arith.index_cast %arg0 : index to i32
          %14 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], indices[%arg0, %c0], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
          %15 = arith.addi %13, %c-1_i32 : i32
          %16 = arith.index_cast %15 : i32 to index
          %17 = arts.datablock "in" ptr[%alloca_0 : memref<100x100xf64>], indices[%16, %c0], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
          %18 = arts.datablock "out" ptr[%alloca : memref<100x100xf64>], indices[%arg0, %c0], sizes[%c1, %c1], type[f64], typeSize[%c8] {isLoad} -> memref<1x1xf64>
          arts.edt dependencies(%17, %18, %14) : (memref<1x1xf64>, memref<1x1xf64>, memref<1x1xf64>) {
            scf.for %arg1 = %c0 to %c100 step %c1 {
