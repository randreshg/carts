  ...
  func.func @compute() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    arts.edt dependencies(%2, %3) : (memref<100x100xf64>, memref<100x100xf64>) attributes {task} {
      ...
      scf.for %arg0 = %c0 to %c100 step %c1 {
        ...
        %14 = arts.datablock "out" ptr[%3 : memref<100x100xf64>], indices[%arg0], sizes[%c100], type[f64], typeSize[%c8] -> memref<100xf64>
      ...
      %11 = arts.datablock "in" ptr[%3 : memref<100x100xf64>], indices[%c0], sizes[%c100], type[f64], typeSize[%c8] -> memref<100xf64>
      %12 = arts.datablock "out" ptr[%2 : memref<100x100xf64>], indices[%c0], sizes[%c100], type[f64], typeSize[%c8] -> memref<100xf64>
      ...
      scf.for %arg0 = %c1 to %c100 step %c1 {
        ...
        %16 = arts.datablock "out" ptr[%2 : memref<100x100xf64>], indices[%arg0], sizes[%c100], type[f64], typeSize[%c8] -> memref<100xf64>
        %17 = arts.datablock "in" ptr[%3 : memref<100x100xf64>], indices[%arg0], sizes[%c100], type[f64], typeSize[%c8] -> memref<100xf64>
        %18 = arts.datablock "in" ptr[%3 : memref<100x100xf64>], indices[%15], sizes[%c100], type[f64], typeSize[%c8] -> memref<100xf64>
