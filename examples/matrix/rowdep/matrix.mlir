  ...
  func.func @main() -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    omp.parallel   {
      ...
      omp.master {
        ...
        scf.for %arg0 = %c0 to %c10 step %c1 {
          ...
          %14 = memref.load %alloca_0[%arg0, %c0] : memref<10x10xf64>
          ...
          omp.task   depend(taskdependout -> %alloca_4 : memref<f64>) {
            ...
            scf.for %arg1 = %c0 to %c10 step %c1 {
              memref.store %16, %alloca_0[%arg0, %arg1] : memref<10x10xf64>
            }
            omp.terminator
          }
        }
        %11 = affine.load %alloca_0[0, 0] : memref<10x10xf64>
        %alloca_5 = memref.alloca() : memref<f64>
        affine.store %11, %alloca_5[] : memref<f64>
        %12 = affine.load %alloca[0, 0] : memref<10x10xf64>
        ...
        omp.task   depend(taskdependin -> %alloca_5 : memref<f64>, taskdependout -> %alloca_6 : memref<f64>) {
          scf.for %arg0 = %c0 to %c10 step %c1 {
            %13 = memref.load %alloca_0[%c0, %arg0] : memref<10x10xf64>
            memref.store %13, %alloca[%c0, %arg0] : memref<10x10xf64>
          }
          omp.terminator
        }
        scf.for %arg0 = %c1 to %c10 step %c1 {
          ...
          %17 = memref.load %alloca_0[%16, %c0] : memref<10x10xf64>
          affine.store %17, %alloca_2[] : memref<f64>
          %18 = memref.load %alloca[%arg0, %c0] : memref<10x10xf64>
          ...
          omp.task   depend(taskdependin -> %alloca_1 : memref<f64>, taskdependin -> %alloca_2 : memref<f64>, taskdependout -> %alloca_3 : memref<f64>) {
            scf.for %arg1 = %c0 to %c10 step %c1 {
              %19 = memref.load %alloca_0[%arg0, %arg1] : memref<10x10xf64>
              %20 = memref.load %alloca_0[%16, %arg1] : memref<10x10xf64>
              %21 = arith.addf %19, %20 : f64
              memref.store %21, %alloca[%arg0, %arg1] : memref<10x10xf64>
            }
            omp.terminator
          }
        }
    ...
    scf.for %arg0 = %c0 to %c10 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c10 step %c1 {
        ...
        %13 = memref.load %alloca_0[%arg0, %arg1] : memref<10x10xf64>
    ...
    scf.for %arg0 = %c0 to %c10 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c10 step %c1 {
        %12 = arith.index_cast %arg1 : index to i32
        %13 = memref.load %alloca[%arg0, %arg1] : memref<10x10xf64>
