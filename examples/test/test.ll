...
entry:
  ...
  %11 = tail call i8* @__kmpc_omp_task_alloc(%struct.ident_t* nonnull @1, i32 %0, i32 1, i64 48, i64 1, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates.1*)* @.omp_task_entry..5 to i32 (i32, i8*)*))
  %12 = getelementptr inbounds i8, i8* %11, i64 40
  %13 = bitcast i8* %12 to i32*
  %14 = load i32, i32* %number, align 4, !tbaa !4
  store i32 %14, i32* %13, align 8, !tbaa !18
  %15 = tail call i32 @__kmpc_omp_task(%struct.ident_t* nonnull @1, i32 %0, i8* %11)
  ret void
}
...
entry:
  ...
  %6 = load i32, i32* %.idx.val, align 4, !tbaa !4, !noalias !24
  %7 = load i32, i32* %.idx2.val, align 4, !tbaa !4, !noalias !24
  %8 = load i32, i32* %4, align 4, !tbaa !4, !alias.scope !24
  %9 = load i32, i32* %5, align 4, !tbaa !4, !alias.scope !24
  %call.i = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([44 x i8], [44 x i8]* @.str, i64 0, i64 0), i32 noundef %6, i32 noundef %7, i32 noundef %8, i32 noundef %9) #6, !noalias !24
  %10 = load i32, i32* %.idx.val, align 4, !tbaa !4, !noalias !24
  %inc.i = add nsw i32 %10, 1
  store i32 %inc.i, i32* %.idx.val, align 4, !tbaa !4, !noalias !24
  %11 = load i32, i32* %.idx2.val, align 4, !tbaa !4, !noalias !24
  %dec.i = add nsw i32 %11, -1
  store i32 %dec.i, i32* %.idx2.val, align 4, !tbaa !4, !noalias !24
  ret i32 0
}
...
entry:
  ...
  %2 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, %struct.kmp_task_t_with_privates.1* %1, i64 0, i32 1, i32 0
  %3 = load i32, i32* %2, align 4, !tbaa !4, !alias.scope !27
  %call.i = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @.str.3, i64 0, i64 0), i32 noundef %3) #6, !noalias !27
  %inc.i = add nsw i32 %3, 1
  store i32 %inc.i, i32* %2, align 4, !tbaa !4, !alias.scope !27
  ret i32 0
}

; Function Attrs: nounwind
declare !callback !30 void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) local_unnamed_addr #6
...
!21 = !{!22, !11, i64 0}
!22 = !{!"_ZTSZ4mainE3$_0", !11, i64 0, !11, i64 8}
!23 = !{!22, !11, i64 8}
!24 = !{!25}
!25 = distinct !{!25, !26, !".omp_outlined..1: %.privates."}
!26 = distinct !{!26, !".omp_outlined..1"}
!27 = !{!28}
!28 = distinct !{!28, !29, !".omp_outlined..2: %.privates."}
