...
// clang fib.c -O3 -march=native -o fib -lstdc++ -I/home/rherreraguaitero/ME/ARTS-env/CARTS/.install/arts/include -L/home/rherreraguaitero/ME/ARTS-env/CARTS/.install/arts/lib -larts -L/usr/lib64/librt.so/usr/lib64/libpthread.so/usr/lib64/lib -lrdmacm

/// clang fib.c -O3 -emit-llvm -c fib -I/home/rherreraguaitero/ME/ARTS-env/CARTS/.install/arts/include 
...
{   
    if(!nodeId && !workerId)
    {
        ...
        artsEdtCreateWithGuid(fibDone, doneGuid, 0, (uint64_t*)&num, 1);
