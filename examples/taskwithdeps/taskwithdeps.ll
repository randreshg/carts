...
@str2 = internal constant [24 x i8] c"Task 1: Initializing a\0A\00"
...
define void @__arts_edt_2(i32 %0, ptr %1, i32 %2, ptr %3) {
  %5 = call i32 (ptr, ...) @printf(ptr @str1)
  %6 = call i32 @artsGetCurrentNode()
  %7 = call i64 @artsEventCreate(i32 %6, i32 1)
  %8 = call i64 @artsGetCurrentEpochGuid()
  %9 = call i32 @artsGetCurrentNode()
  %10 = alloca i64, i64 1, align 8
  store i64 %7, ptr %10, align 8
  %11 = call i64 @artsEdtCreateWithEpoch(ptr @__arts_edt_3, i32 %9, i32 1, ptr %10, i32 0, i64 %8)
  %12 = call i32 @artsGetCurrentNode()
  %13 = call i64 @artsEventCreate(i32 %12, i32 1)
  %14 = call i64 @artsGetCurrentEpochGuid()
  %15 = call i32 @artsGetCurrentNode()
  %16 = alloca i64, i64 1, align 8
  store i64 %13, ptr %16, align 8
  %17 = call i64 @artsEdtCreateWithEpoch(ptr @__arts_edt_4, i32 %15, i32 1, ptr %16, i32 1, i64 %14)
  call void @artsAddDependence(i64 %7, i64 %17, i32 0)
  %18 = call i64 @artsGetCurrentEpochGuid()
  %19 = call i32 @artsGetCurrentNode()
  %20 = alloca i64, i64 0, align 8
  %21 = call i64 @artsEdtCreateWithEpoch(ptr @__arts_edt_5, i32 %19, i32 0, ptr %20, i32 1, i64 %18)
  call void @artsAddDependence(i64 %13, i64 %21, i32 0)
  ret void
}
...
define void @__arts_edt_3(i32 %0, ptr %1, i32 %2, ptr %3) {
  ...
  %8 = call i32 (ptr, ...) @printf(ptr @str2)
...
define void @__arts_edt_4(i32 %0, ptr %1, i32 %2, ptr %3) {
  ...
  %6 = load i64, ptr %5, align 8
  %7 = getelementptr { i64, i32, ptr }, ptr %3, i32 0, i32 2
  %8 = getelementptr { i64, i32, ptr }, ptr %3, i32 24
  %9 = getelementptr { i64, i32, ptr }, ptr %8, i32 0, i32 2
  %10 = load i32, ptr %9, align 4
  %11 = call i32 (ptr, ...) @printf(ptr @str3, i32 %10)
  %12 = add i32 %10, 5
  store i32 %12, ptr %7, align 4
  %13 = load i64, ptr %1, align 8
  call void @artsEventSatisfySlot(i64 %13, i64 %6, i32 0)
  ret void
}
...
define void @__arts_edt_5(i32 %0, ptr %1, i32 %2, ptr %3) {
  ...
  %7 = call i32 (ptr, ...) @printf(ptr @str4, i32 %6)
  ret void
}
...
define i32 @mainBody() {
  ...
  %18 = call i32 (ptr, ...) @printf(ptr @str5, i32 %16, i32 %17)
  %19 = call i32 (ptr, ...) @printf(ptr @str6)
  ret i32 0
}
