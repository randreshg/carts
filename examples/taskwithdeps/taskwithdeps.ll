...
entry:
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !401, metadata !DIExpression()), !dbg !406
  tail call void @llvm.dbg.value(metadata ptr %1, metadata !402, metadata !DIExpression()), !dbg !406
  call void @llvm.dbg.value(metadata i32 poison, metadata !407, metadata !DIExpression()), !dbg !424
  call void @llvm.dbg.value(metadata ptr %1, metadata !416, metadata !DIExpression(DW_OP_plus_uconst, 16, DW_OP_stack_value)), !dbg !424
  call void @llvm.dbg.value(metadata ptr %1, metadata !417, metadata !DIExpression(DW_OP_plus_uconst, 40, DW_OP_stack_value)), !dbg !424
  call void @llvm.dbg.value(metadata !335, metadata !418, metadata !DIExpression()), !dbg !424
  call void @llvm.dbg.value(metadata ptr %1, metadata !419, metadata !DIExpression()), !dbg !424
  call void @llvm.dbg.value(metadata ptr poison, metadata !420, metadata !DIExpression()), !dbg !424
  tail call void @llvm.dbg.value(metadata ptr %1, metadata !426, metadata !DIExpression(DW_OP_plus_uconst, 40, DW_OP_stack_value)), !dbg !436
  tail call void @llvm.dbg.value(metadata ptr undef, metadata !429, metadata !DIExpression()), !dbg !436
  tail call void @llvm.dbg.value(metadata ptr undef, metadata !430, metadata !DIExpression()), !dbg !436
  tail call void @llvm.dbg.value(metadata ptr undef, metadata !431, metadata !DIExpression()), !dbg !436
  %2 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, ptr %1, i64 0, i32 1, i32 1, !dbg !438
  %3 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, ptr %1, i64 0, i32 1, i32 2, !dbg !438
  call void @llvm.dbg.value(metadata ptr %1, metadata !421, metadata !DIExpression(DW_OP_plus_uconst, 40, DW_OP_deref, DW_OP_stack_value)), !dbg !424
  call void @llvm.dbg.value(metadata ptr %3, metadata !422, metadata !DIExpression(DW_OP_deref)), !dbg !424
  call void @llvm.dbg.value(metadata ptr %2, metadata !423, metadata !DIExpression(DW_OP_deref)), !dbg !424
  %4 = load ptr, ptr %2, align 8, !dbg !439, !tbaa !397
  %5 = load i32, ptr %3, align 4, !dbg !440, !tbaa !395
  %idxprom.i = sext i32 %5 to i64, !dbg !439
  %arrayidx.i = getelementptr inbounds double, ptr %4, i64 %idxprom.i, !dbg !439
  %6 = load double, ptr %arrayidx.i, align 8, !dbg !439, !tbaa !280
  %cmp.i = icmp sgt i32 %5, 0, !dbg !441
  br i1 %cmp.i, label %cond.true.i, label %.omp_outlined..1.exit, !dbg !442

cond.true.i:                                      ; preds = %entry
  %7 = zext nneg i32 %5 to i64, !dbg !443
  %8 = getelementptr double, ptr %4, i64 %7, !dbg !443
  %arrayidx4.i = getelementptr double, ptr %8, i64 -1, !dbg !443
  %9 = load double, ptr %arrayidx4.i, align 8, !dbg !443, !tbaa !280
  br label %.omp_outlined..1.exit, !dbg !442

.omp_outlined..1.exit:                            ; preds = %entry, %cond.true.i
  %cond.i = phi double [ %9, %cond.true.i ], [ 0.000000e+00, %entry ], !dbg !442
  %10 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, ptr %1, i64 0, i32 1, !dbg !444
  call void @llvm.dbg.value(metadata ptr %10, metadata !417, metadata !DIExpression()), !dbg !424
  tail call void @llvm.dbg.value(metadata ptr %10, metadata !426, metadata !DIExpression()), !dbg !436
  call void @llvm.dbg.value(metadata ptr %10, metadata !421, metadata !DIExpression(DW_OP_deref)), !dbg !424
  %add.i = fadd double %6, %cond.i, !dbg !445
  %11 = load ptr, ptr %10, align 8, !dbg !446, !tbaa !397
  %arrayidx6.i = getelementptr inbounds double, ptr %11, i64 %idxprom.i, !dbg !446
  store double %add.i, ptr %arrayidx6.i, align 8, !dbg !447, !tbaa !280
  ret i32 0, !dbg !444
}
...
!341 = !DICompositeType(tag: DW_TAG_structure_type, name: "kmp_task_t_with_privates", file: !1, size: 448, flags: DIFlagFwdDecl, identifier: "_ZTS24kmp_task_t_with_privates")
...
!390 = !DICompositeType(tag: DW_TAG_structure_type, name: ".kmp_privates.t", file: !1, size: 128, flags: DIFlagFwdDecl, identifier: "_ZTS15.kmp_privates.t")
...
!402 = !DILocalVariable(arg: 2, scope: !399, type: !403, flags: DIFlagArtificial)
!403 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !404)
!404 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !405, size: 64)
!405 = !DICompositeType(tag: DW_TAG_structure_type, name: "kmp_task_t_with_privates", file: !1, size: 512, flags: DIFlagFwdDecl, identifier: "_ZTS24kmp_task_t_with_privates")
!406 = !DILocation(line: 0, scope: !399)
!407 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !408, type: !348, flags: DIFlagArtificial)
!408 = distinct !DISubprogram(name: ".omp_outlined..1", scope: !1, file: !1, type: !409, scopeLine: 47, flags: DIFlagArtificial | DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !415)
!409 = !DISubroutineType(types: !410)
!410 = !{null, !348, !349, !352, !354, !359, !411}
!411 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !412)
!412 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !413)
!413 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !414, size: 64)
!414 = !DICompositeType(tag: DW_TAG_structure_type, scope: !289, file: !1, line: 46, size: 8, flags: DIFlagFwdDecl)
!415 = !{!407, !416, !417, !418, !419, !420, !421, !422, !423}
!416 = !DILocalVariable(name: ".part_id.", arg: 2, scope: !408, type: !349, flags: DIFlagArtificial)
!417 = !DILocalVariable(name: ".privates.", arg: 3, scope: !408, type: !352, flags: DIFlagArtificial)
!418 = !DILocalVariable(name: ".copy_fn.", arg: 4, scope: !408, type: !354, flags: DIFlagArtificial)
!419 = !DILocalVariable(name: ".task_t.", arg: 5, scope: !408, type: !359, flags: DIFlagArtificial)
!420 = !DILocalVariable(name: "__context", arg: 6, scope: !408, type: !411, flags: DIFlagArtificial)
!421 = !DILocalVariable(name: "B", scope: !408, file: !1, line: 35, type: !264)
!422 = !DILocalVariable(name: "i", scope: !408, file: !1, line: 40, type: !9)
!423 = !DILocalVariable(name: "A", scope: !408, file: !1, line: 35, type: !264)
!424 = !DILocation(line: 0, scope: !408, inlinedAt: !425)
!425 = distinct !DILocation(line: 46, column: 13, scope: !399)
!426 = !DILocalVariable(arg: 1, scope: !427, type: !432, flags: DIFlagArtificial)
!427 = distinct !DISubprogram(linkageName: ".omp_task_privates_map..2", scope: !1, file: !1, line: 46, type: !334, scopeLine: 46, flags: DIFlagArtificial | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !428)
!428 = !{!426, !429, !430, !431}
!429 = !DILocalVariable(arg: 2, scope: !427, type: !378, flags: DIFlagArtificial)
!430 = !DILocalVariable(arg: 3, scope: !427, type: !383, flags: DIFlagArtificial)
!431 = !DILocalVariable(arg: 4, scope: !427, type: !378, flags: DIFlagArtificial)
!432 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !433)
!433 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !434)
!434 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !435, size: 64)
!435 = !DICompositeType(tag: DW_TAG_structure_type, name: ".kmp_privates.t", file: !1, size: 192, flags: DIFlagFwdDecl, identifier: "_ZTS15.kmp_privates.t")
!436 = !DILocation(line: 0, scope: !427, inlinedAt: !437)
!437 = distinct !DILocation(line: 46, column: 13, scope: !408, inlinedAt: !425)
!438 = !DILocation(line: 46, column: 13, scope: !427, inlinedAt: !437)
!439 = !DILocation(line: 47, column: 20, scope: !408, inlinedAt: !425)
!440 = !DILocation(line: 47, column: 22, scope: !408, inlinedAt: !425)
!441 = !DILocation(line: 47, column: 30, scope: !408, inlinedAt: !425)
!442 = !DILocation(line: 47, column: 28, scope: !408, inlinedAt: !425)
!443 = !DILocation(line: 47, column: 36, scope: !408, inlinedAt: !425)
!444 = !DILocation(line: 46, column: 13, scope: !399)
!445 = !DILocation(line: 47, column: 25, scope: !408, inlinedAt: !425)
!446 = !DILocation(line: 47, column: 13, scope: !408, inlinedAt: !425)
!447 = !DILocation(line: 47, column: 18, scope: !408, inlinedAt: !425)
