clang++ -fopenmp -O1 -g3 -emit-ast -o taskwithdeps.ast taskwithdeps.cpp
clang++ -fopenmp -O1 -g3 -emit-llvm -c taskwithdeps.cpp -o taskwithdeps.bc -lstdc++
...
-------------------------------------------------
- - - - - - - - - - - - - - - - - - - - - 
Analyzing loops in function: _Z4funciPd
- - - - - - - - - - - - - - -
Loop at depth 1
...
Loop does not have dedicated exits.
No induction variable found by Scalar Evolution. Attempting manual detection.
Detected Induction Variable (Manual):   %indvars.iv = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next, %for.body ]
Backedge-taken count: (-1 + (zext i32 %N to i64))<nsw>
Analyzing dependencies...
GEP Access Pattern: {%A,+,8}<nuw><%for.body>
Store Access Pattern: {%A,+,8}<nuw><%for.body>
- - - - - - - - - - - - - - - - - - - - - 
Analyzing loops in function: _Z7computeiPdS_
- - - - - - - - - - - - - - -
Loop at depth 1
Loop at depth 1 containing: %for.body<header><latch><exiting>
Loop is not in simplified form.
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %wide.trip.count = zext nneg i32 %N to i64, !dbg !277
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  tail call void @llvm.dbg.value(metadata i64 %indvars.iv, metadata !269, metadata !DIExpression()), !dbg !276
  %11 = call ptr @__kmpc_omp_task_alloc(ptr nonnull @1, i32 %0, i32 1, i64 56, i64 1, ptr nonnull @.omp_task_entry.), !dbg !280
  %12 = getelementptr inbounds %struct.kmp_task_t_with_privates, ptr %11, i64 0, i32 1, !dbg !280
  store ptr %A, ptr %12, align 8, !dbg !280, !tbaa !281
  %13 = getelementptr inbounds %struct.kmp_task_t_with_privates, ptr %11, i64 0, i32 1, i32 1, !dbg !280
  %14 = trunc i64 %indvars.iv to i32, !dbg !280
  store i32 %14, ptr %13, align 8, !dbg !280, !tbaa !289
  %arrayidx = getelementptr double, ptr %A, i64 %indvars.iv, !dbg !290
  %15 = ptrtoint ptr %arrayidx to i64, !dbg !280
  store i64 %15, ptr %.dep.arr.addr, align 8, !dbg !280, !tbaa !291
  store i64 8, ptr %1, align 8, !dbg !280, !tbaa !294
  store i8 3, ptr %2, align 8, !dbg !280, !tbaa !295
  %16 = call i32 @__kmpc_omp_task_with_deps(ptr nonnull @1, i32 %0, ptr %11, i32 1, ptr nonnull %.dep.arr.addr, i32 0, ptr null), !dbg !280
  %17 = call ptr @__kmpc_omp_task_alloc(ptr nonnull @3, i32 %0, i32 1, i64 64, i64 1, ptr nonnull @.omp_task_entry..3), !dbg !296
  %18 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, ptr %17, i64 0, i32 1, !dbg !296
  store ptr %B, ptr %18, align 8, !dbg !296, !tbaa !297
  %19 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, ptr %17, i64 0, i32 1, i32 1, !dbg !296
  store ptr %A, ptr %19, align 8, !dbg !296, !tbaa !300
  %20 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, ptr %17, i64 0, i32 1, i32 2, !dbg !296
  %21 = trunc i64 %indvars.iv to i32, !dbg !296
  store i32 %21, ptr %20, align 8, !dbg !296, !tbaa !301
  store i64 %15, ptr %.dep.arr.addr2, align 8, !dbg !296, !tbaa !291
  store i64 8, ptr %3, align 8, !dbg !296, !tbaa !294
  store i8 1, ptr %4, align 8, !dbg !296, !tbaa !295
  %arrayidx6 = getelementptr double, ptr %arrayidx, i64 -1, !dbg !302
  %22 = ptrtoint ptr %arrayidx6 to i64, !dbg !296
  store i64 %22, ptr %5, align 8, !dbg !296, !tbaa !291
  store i64 8, ptr %6, align 8, !dbg !296, !tbaa !294
  store i8 1, ptr %7, align 8, !dbg !296, !tbaa !295
  %arrayidx8 = getelementptr inbounds double, ptr %B, i64 %indvars.iv, !dbg !304
  %23 = ptrtoint ptr %arrayidx8 to i64, !dbg !296
  store i64 %23, ptr %8, align 8, !dbg !296, !tbaa !291
  store i64 8, ptr %9, align 8, !dbg !296, !tbaa !294
  store i8 3, ptr %10, align 8, !dbg !296, !tbaa !295
  %24 = call i32 @__kmpc_omp_task_with_deps(ptr nonnull @3, i32 %0, ptr %17, i32 3, ptr nonnull %.dep.arr.addr2, i32 0, ptr null), !dbg !296
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !305
  tail call void @llvm.dbg.value(metadata i64 %indvars.iv.next, metadata !269, metadata !DIExpression()), !dbg !276
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count, !dbg !277
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !dbg !278, !llvm.loop !306

Loop does not have dedicated exits.
No induction variable found by Scalar Evolution. Attempting manual detection.
Detected Induction Variable (Manual):   %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.body ]
Backedge-taken count: (-1 + (zext i32 %N to i64))<nsw>

Analyzing dependencies...
GEP Access Pattern: (40 + %11)
Store Access Pattern: (40 + %11)
GEP Access Pattern: (48 + %11)
Store Access Pattern: (48 + %11)
GEP Access Pattern: {%A,+,8}<nw><%for.body>
Store Access Pattern: %.dep.arr.addr
Store Access Pattern: (8 + %.dep.arr.addr)< >
Store Access Pattern: (16 + %.dep.arr.addr)<nuw>
GEP Access Pattern: (40 + %17)
Store Access Pattern: (40 + %17)
GEP Access Pattern: (48 + %17)
Store Access Pattern: (48 + %17)
GEP Access Pattern: (56 + %17)
Store Access Pattern: (56 + %17)
Store Access Pattern: %.dep.arr.addr2
Store Access Pattern: (8 + %.dep.arr.addr2)<nuw>
Store Access Pattern: (16 + %.dep.arr.addr2)<nuw>
GEP Access Pattern: {(-8 + %A),+,8}<nw><%for.body>
Store Access Pattern: (24 + %.dep.arr.addr2)<nuw>
Store Access Pattern: (32 + %.dep.arr.addr2)<nuw>
Store Access Pattern: (40 + %.dep.arr.addr2)<nuw>
GEP Access Pattern: {%B,+,8}<nw><%for.body>
Store Access Pattern: (48 + %.dep.arr.addr2)<nuw>
Store Access Pattern: (56 + %.dep.arr.addr2)<nuw>
Store Access Pattern: (64 + %.dep.arr.addr2)<nuw>
- - - - - - - - - - - - - - - - - - - - - 
Analyzing loops in function: .omp_task_entry.
- - - - - - - - - - - - - - - - - - - - - 
Analyzing loops in function: .omp_task_entry..3
[omp-visitor] Running OMPVisitor
Found OpenMP Directive (OMPTaskDirective) at /home/randres/projects/carts/examples/taskwithdeps/taskwithdeps.cpp:42:13
- - - - - - - - - - - - - - - 
  Processing task directive...
    Dependency type: 1
    Dependency variable: 0x56166dfb3b28
    (Unhandled clause type)
Found OpenMP Directive (OMPTaskDirective) at /home/randres/projects/carts/examples/taskwithdeps/taskwithdeps.cpp:46:13
- - - - - - - - - - - - - - - 
  Processing task directive...
    Dependency type: 0
    Dependency variable: 0x56166e02f3c8
    Dependency variable: 0x56166e02f338
    Dependency type: 1
    Dependency variable: 0x56166e02f268
    (Unhandled clause type)
- - - - - - - - - - - - - - - - - - - 
Printing OpenMP Directive Hierarchy...
Directive: task
  Location: /home/randres/projects/carts/examples/taskwithdeps/taskwithdeps.cpp:42:13
  Instruction:   ret i32 0, !dbg !271
  Dependencies: No
Directive: task
  Location: /home/randres/projects/carts/examples/taskwithdeps/taskwithdeps.cpp:46:13
  Instruction:   ret i32 0, !dbg !346
-------------------------------------------------
...
[arts-codegen] ARTSCodegen initialized
 - Analyzing Functions
-- Function: _Z4funciPd
[arts] Function: _Z4funciPd doesn't have CARTS Metadata

-- Function: _Z7computeiPdS_
[arts] Function: _Z7computeiPdS_ doesn't have CARTS Metadata

-- Function: .omp_task_entry.
[arts] Function: .omp_task_entry. doesn't have CARTS Metadata

-- Function: .omp_task_entry..3
[arts] Function: .omp_task_entry..3 doesn't have CARTS Metadata
...
0.	Program arguments: opt -load-pass-plugin=/home/randres/projects/carts/.install/carts/lib/ARTSAnalysis.so -debug-only=arts-analysis,arts,carts,arts-ir-builder,arts-graph,carts-metadata,arts-codegen -passes=arts-analysis taskwithdeps_arts_ir.bc -o taskwithdeps_arts_analysis.bc
 #0 0x00007fb59cac16b7 llvm::sys::PrintStackTrace(llvm::raw_ostream&, int) (/home/randres/projects/carts/.install/llvm/lib/libLLVMSupport.so.18.1+0x1926b7)
 #1 0x00007fb59cabf21e llvm::sys::RunSignalHandlers() (/home/randres/projects/carts/.install/llvm/lib/libLLVMSupport.so.18.1+0x19021e)
 #2 0x00007fb59cac1d8a SignalHandler(int) Signals.cpp:0:0
 #3 0x00007fb59c40c520 (/lib/x86_64-linux-gnu/libc.so.6+0x42520)
 #4 0x00007fb59c4609fc pthread_kill (/lib/x86_64-linux-gnu/libc.so.6+0x969fc)
 #5 0x00007fb59c40c476 gsignal (/lib/x86_64-linux-gnu/libc.so.6+0x42476)
 #6 0x00007fb59c3f27f3 abort (/lib/x86_64-linux-gnu/libc.so.6+0x287f3)
 #7 0x00007fb59c3f271b (/lib/x86_64-linux-gnu/libc.so.6+0x2871b)
 #8 0x00007fb59c403e96 (/lib/x86_64-linux-gnu/libc.so.6+0x39e96)
 #9 0x00007fb59b15843e (/home/randres/projects/carts/.install/carts/lib/ARTSAnalysis.so+0x2343e)
#10 0x00007fb59cec7576 llvm::PassManager<llvm::Module, llvm::AnalysisManager<llvm::Module>>::run(llvm::Module&, llvm::AnalysisManager<llvm::Module>&) (/home/randres/projects/carts/.install/llvm/lib/libLLVMCore.so.18.1+0x2c9576)
#11 0x000055d008c3eacb llvm::runPassPipeline(llvm::StringRef, llvm::Module&, llvm::TargetMachine*, llvm::TargetLibraryInfoImpl*, llvm::ToolOutputFile*, llvm::ToolOutputFile*, llvm::ToolOutputFile*, llvm::StringRef, llvm::ArrayRef<llvm::PassPlugin>, llvm::opt_tool::OutputKind, llvm::opt_tool::VerifierKind, bool, bool, bool, bool, bool, bool, bool) (/home/randres/projects/carts/.install/llvm/bin/opt+0x19acb)
#12 0x000055d008c4c900 main (/home/randres/projects/carts/.install/llvm/bin/opt+0x27900)
#13 0x00007fb59c3f3d90 (/lib/x86_64-linux-gnu/libc.so.6+0x29d90)
#14 0x00007fb59c3f3e40 __libc_start_main (/lib/x86_64-linux-gnu/libc.so.6+0x29e40)
#15 0x000055d008c37ef5 _start (/home/randres/projects/carts/.install/llvm/bin/opt+0x12ef5)
Aborted
make: *** [Makefile:29: taskwithdeps_arts_analysis.bc] Error 134
