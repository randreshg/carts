...
define internal void @main.omp_outlined(ptr noalias nocapture noundef readonly %.global_tid., ptr noalias nocapture readnone %.bound_tid., ptr noundef nonnull align 4 dereferenceable(4) %shared_number, ptr noundef nonnull align 4 dereferenceable(4) %random_number) #4 personality ptr @__gxx_personality_v0 {
entry:
...
omp_if.then:                                      ; preds = %entry
  ...
  %3 = load i32, ptr %random_number, align 4, !tbaa !6
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %2, i32 noundef %3)
  %4 = tail call ptr @__kmpc_omp_task_alloc(ptr nonnull @1, i32 %0, i32 1, i64 48, i64 8, ptr nonnull @.omp_task_entry.)
  %5 = load ptr, ptr %4, align 8, !tbaa !10
  store ptr %shared_number, ptr %5, align 8, !tbaa.struct !15
  %6 = getelementptr inbounds %struct.kmp_task_t_with_privates, ptr %4, i64 0, i32 1
  %7 = load i32, ptr %random_number, align 4, !tbaa !6
  store i32 %7, ptr %6, align 8, !tbaa !17
  %8 = tail call i32 @__kmpc_omp_task(ptr nonnull @1, i32 %0, ptr nonnull %4)
  %9 = tail call i32 @__kmpc_omp_taskwait(ptr nonnull @1, i32 %0)
  %10 = tail call ptr @__kmpc_omp_task_alloc(ptr nonnull @1, i32 %0, i32 1, i64 48, i64 8, ptr nonnull @.omp_task_entry..6)
  %11 = load ptr, ptr %10, align 8, !tbaa !10
  store ptr %random_number, ptr %11, align 8, !tbaa.struct !15
  %12 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, ptr %10, i64 0, i32 1
  %13 = load i32, ptr %shared_number, align 4, !tbaa !6
  store i32 %13, ptr %12, align 8, !tbaa !17
  %14 = tail call i32 @__kmpc_omp_task(ptr nonnull @1, i32 %0, ptr nonnull %10)
...
define internal noundef i32 @.omp_task_entry.(i32 %0, ptr noalias nocapture noundef %1) #6 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: nofree norecurse nounwind uwtable
define internal noundef i32 @.omp_task_entry..6(i32 %0, ptr noalias nocapture noundef %1) #6 personality ptr @__gxx_personality_v0 {
entry:
  %2 = load ptr, ptr %1, align 8, !tbaa !10
  %3 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, ptr %1, i64 0, i32 1
  tail call void @llvm.experimental.noalias.scope.decl(metadata !25)
  %4 = load i32, ptr %3, align 4, !tbaa !6, !noalias !25
  %inc.i = add nsw i32 %4, 1
  store i32 %inc.i, ptr %3, align 4, !tbaa !6, !noalias !25
  %5 = load ptr, ptr %2, align 8, !tbaa !28, !alias.scope !25, !noalias !30
  %6 = load i32, ptr %5, align 4, !tbaa !6, !noalias !25
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, i32 noundef %inc.i, i32 noundef %6), !noalias !25
  ret i32 0
}
...
; Function Attrs: nounwind
declare !callback !32 void @__kmpc_fork_call(ptr, i32, ptr, ...) local_unnamed_addr #7
...
!28 = !{!29, !13, i64 0}
!29 = !{!"_ZTSZ4mainE3$_1", !13, i64 0}
!30 = !{!31}
!31 = distinct !{!31, !27, !".omp_outlined..3: %.privates."}
!32 = !{!33}
