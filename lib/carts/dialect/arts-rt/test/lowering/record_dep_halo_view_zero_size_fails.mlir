...
module attributes {
  ...
  func.func @record_dep_halo_view_zero_size_fails(%edt: i64) {
    ...
    arts_rt.rec_dep %edt(%acq_guid : memref<?xi64>) byte_offsets(%c0) byte_sizes(%c0) {acquire_modes = array<i32: 1>, dep_flags = array<i32: 4>}
    return
  }
}
