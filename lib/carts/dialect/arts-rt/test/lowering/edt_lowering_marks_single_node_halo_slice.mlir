...
// path. ARTS-RT consumes explicit element windows and tags the dependency as a
// halo view before runtime-call lowering.
...
module attributes {
  ...
  func.func @edt_lowering_marks_single_node_halo_slice() {
    ...
    arts.edt <task> <intranode> route(%route) (%acq_ptr) : memref<?xmemref<?xf64>> attributes {perBlockHaloExchange} {
