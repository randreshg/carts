...
module attributes {
  ...
  func.func @record_dep_non_halo_byte_window_fails(%edt: i64) {
    ...
    arts_rt.rec_dep %edt(%acq_guid : memref<?xi64>) byte_offsets(%c0) byte_sizes(%c8) {acquire_modes = array<i32: 1>}
    return
  }
}
