...
// A benchmark module can contain a repeated streaming bundle that should stay
// as host OpenMP plus unrelated OpenMP work that should still enter SDE. The
// fallback marker must stay on the selected islands instead of marking every
// OpenMP op in the module.
