...
// host OpenMP. Lowering each map in every repetition to an ARTS epoch preserves
// correctness, but loses the source bandwidth-control shape to launch overhead.
