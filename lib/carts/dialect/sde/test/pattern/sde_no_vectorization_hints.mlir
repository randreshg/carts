...
// SDE planning commits real layout/schedule structure and stamps no
// vectorization hint attributes: width/unroll/interleave are not SDE planning
// facts.

// CHECK: sde.su_iterate
// CHECK: memref.store
// CHECK-NOT: vectorizeWidth
// CHECK-NOT: unrollFactor
// CHECK-NOT: interleaveCount
