...
// CHECK: logicalShape disagrees with sde.mu_alloc static shape
func.func @incoherent_logical_shape() {
  ...
  ^bb0(%i: index):
    sde.array_layout write array_id(0) owner [0] block [256] logical [512]
