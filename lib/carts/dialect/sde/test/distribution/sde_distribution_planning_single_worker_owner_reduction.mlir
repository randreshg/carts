...
// SDE: } {iterationTopology = #sde.iteration_topology<owner_strip>, logicalWorkerSlice = [128, 30], partitionGraph = [
// SDE-SAME: layoutKind = "owner_block"
// SDE-SAME: role = "write"
// SDE-SAME: partitionScore = {
// SDE-SAME: chosenCuCount = 1 : i64
