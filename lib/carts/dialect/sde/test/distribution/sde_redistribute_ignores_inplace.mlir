...
func.func @inplace(%T: memref<256x256xf32>, %E: memref<256x256xf32>,
  ...
  sde.cu_region <parallel> {
    ...
    ^bb0(%i: index, %j: index):
      ...
      sde.yield
    } {inPlaceSafe, arrayLayout = [{arrayId = 0 : i64, kind = "block_contraction", ownerDims = [0], blockShape = [128, 256], muBlockCount = 2 : i64, role = "read", commVolumeBytes = 2097152 : i64}], layoutsDisagree = [0]}
    sde.yield
  }
  return
}
