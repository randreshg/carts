...
// copy/stencil pair with alternating read/write roots is an SDE alternating-buffer stencil
// timestep candidate. It is stamped advance_stage with a full_timestep
...
// CHECK: } {
// CHECK-SAME: asyncStrategy = #sde.async_strategy<advance_stage>
// CHECK-SAME: pattern = #sde.pattern<alternating_buffer_stencil>
// CHECK-SAME: repetitionStructure = #sde.repetition_structure<full_timestep>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f64, dense<64> : vector<2xi64>>, #dlti.dl_entry<i64, dense<64> : vector<2xi64>>, #dlti.dl_entry<i32, dense<32> : vector<2xi64>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi64>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i64>>, llvm.data_layout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128", llvm.target_triple = "aarch64-unknown-linux-gnu"} {
  func.func @alternating_buffer_pair(%A: memref<18x18xf64>, %B: memref<18x18xf64>) {
