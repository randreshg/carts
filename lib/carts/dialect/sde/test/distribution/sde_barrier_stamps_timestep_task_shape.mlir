...
// Barrier analysis stamps them advance_stage with a full_timestep repetition
// structure.
...
// CHECK-SAME: asyncStrategy = #sde.async_strategy<advance_stage>
// CHECK-SAME: repetitionStructure = #sde.repetition_structure<full_timestep>
// CHECK-LABEL: // -----// IR Dump After RealizeEdtDistributionPlan (realize-edt-distribution-plan) //----- //
// CHECK: func.func @timestep_pair
