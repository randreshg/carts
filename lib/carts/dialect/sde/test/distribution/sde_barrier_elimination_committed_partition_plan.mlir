...
// BarrierElimination may stamp timestep/CPS intent after distribution
// planning, but it must not coarsen a physical owner-tile shape once the
// CU/MU partition graph and score are committed to that shape.
