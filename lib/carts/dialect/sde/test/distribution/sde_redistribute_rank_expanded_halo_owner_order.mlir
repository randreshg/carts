...
func.func @expanded_halo_permuted_owner_order(%U: memref<4x4x55x72x72x7xf64>) {
  ...
  } {arrayLayout = [{arrayId = 3 : i64, kind = "block_parallel", ownerDims = [2, 1, 0], blockShape = [144, 288, 7], muBlockCount = 880 : i64, role = "read", commVolumeBytes = 99 : i64}], physicalOwnerDims = [2, 1, 0], physicalBlockShape = [72, 72, 7], physicalHaloShape = [1, 1, 1]}
  }
  return
}
