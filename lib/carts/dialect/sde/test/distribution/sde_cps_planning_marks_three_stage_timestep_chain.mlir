...
// SDE groups adjacent repeated timestep stages as one CPS candidate chain,
// not as disconnected pairs. The chain remains a candidate until token-local
// stencil dataflow can carry every stage value explicitly.

// CHECK-LABEL: // -----// IR Dump After BarrierElimination (barrier-elimination) //----- //
// CHECK: func.func @three_stage_timestep_chain
// CHECK: scf.for
...
// CHECK: %[[DONE0:[0-9]+]] = sde.control_token : !sde.completion
// CHECK: sde.su_barrier(%[[DONE0]] : !sde.completion)
...
// CHECK-SAME: repetitionStructure = #sde.repetition_structure<full_timestep>
// CHECK: %[[DONE1:[0-9]+]] = sde.control_token : !sde.completion
// CHECK: sde.su_barrier(%[[DONE1]] : !sde.completion)
// CHECK-SAME: barrierReason = #sde.barrier_reason<timestep_stage_boundary>
// CHECK: sde.su_iterate
// CHECK: } {
// CHECK-SAME: asyncStrategy = #sde.async_strategy<advance_edt>
...
// CHECK-SAME: cps_candidate_requires_tokenized_dataflow
// CHECK-SAME: cps_candidate_stage_count = 3 : i64
// CHECK-SAME: cps_candidate_stage_index = 2 : i64
// CHECK-SAME: repetitionStructure = #sde.repetition_structure<full_timestep>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f64, dense<64> : vector<2xi64>>, #dlti.dl_entry<i64, dense<64> : vector<2xi64>>, #dlti.dl_entry<i32, dense<32> : vector<2xi64>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi64>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i64>>, llvm.data_layout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128", llvm.target_triple = "aarch64-unknown-linux-gnu"} {
  func.func @three_stage_timestep_chain(%A: memref<18x18xf64>, %B: memref<18x18xf64>) {
