...
// ARTS: func.func @main
// ARTS: arts.edt <task>
// ARTS: arts.edt <task>{{.*}}depPattern = #arts.dep_pattern<uniform>{{.*}}distribution_kind = #arts.distribution_kind<block>{{.*}}distribution_pattern = #arts.distribution_pattern<uniform>{{.*}}distribution_version = 1 : i32
// ARTS-NOT: sde.
