...
// RUN:   --start-from sde-planning --pipeline codir-to-arts 2>&1 | %FileCheck %s

// CODIR-to-ARTS must not receive residual SDE dependency structure from an
// incomplete source-to-CODIR conversion.
