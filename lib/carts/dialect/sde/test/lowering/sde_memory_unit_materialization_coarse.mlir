// RUN: %carts-compile %s --pass-pipeline='builtin.module(convert-sde-to-codir,verify-codir,storage-planning,materialize-sde-boundary-to-arts,convert-codir-to-arts)' \
