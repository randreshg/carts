...
module attributes {arts.runtime_total_nodes = 1 : i64, arts.runtime_total_workers = 4 : i64} {
  func.func @single_node_local_only_with_distributed_writer() {
    ...
    arts.edt <task> <intranode> route(%route) (%write_ptr, %read_ptr) : memref<?xmemref<?xf64>>, memref<?xmemref<?xf64>> {
