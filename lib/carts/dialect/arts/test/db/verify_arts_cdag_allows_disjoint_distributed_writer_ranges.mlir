...
// CHECK-LABEL: func.func @disjoint_distributed_writer_ranges_allowed
// CHECK-NOT: second concurrent writer
// CHECK-NOT: block disjointness cannot be proven

module attributes {arts.runtime_total_nodes = 2 : i64, arts.runtime_total_workers = 8 : i64} {
  func.func @disjoint_distributed_writer_ranges_allowed() {
