...
module attributes {arts.runtime_total_nodes = 4 : i64, arts.runtime_total_workers = 256 : i64} {
  func.func @owner_block_shape_must_preserve_plan_physical_block_shape() {
    ...
    %guid, %ptr = arts.db_alloc[<inout>, <heap>, <write>, <block>]
      ...
      {distributed, owner_block_shape = [2], owner_map_dims = [0],
...
// CHECK: owner_block_shape must preserve planPhysicalBlockShape for distributed ownership
