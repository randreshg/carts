...
module attributes {arts.runtime_total_nodes = 4 : i64, arts.runtime_total_workers = 256 : i64} {
  func.func @distributed_db_cannot_keep_reject_reason() {
    ...
    %guid, %ptr = arts.db_alloc[<inout>, <heap>, <write>, <block>]
      ...
      {distributed, distributed_reject_reason = "missing_owner_map",
       owner_block_shape = [1], owner_map_dims = [0],
...
// CHECK: cannot be both distributed and rejected for distributed ownership
