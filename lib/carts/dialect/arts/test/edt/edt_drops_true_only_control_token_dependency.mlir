...
module {
  func.func @drops_true_only_control_dependency() {
    ...
    %ctrl_guid, %ctrl_ptr = arts.db_alloc[<inout>, <heap>, <write>, <coarse>] route(%c-1_i32 : i32) sizes[%c1] elementType(i1) elementSizes[%c1] : (memref<?xi64>, memref<?xmemref<?xi1>>)
    %data_guid, %data_ptr = arts.db_alloc[<inout>, <heap>, <write>, <coarse>] route(%c-1_i32 : i32) sizes[%c1] elementType(f64) elementSizes[%c1] : (memref<?xi64>, memref<?xmemref<?xf64>>)
