///==========================================================================///
/// File: CodirCodeletDCE.cpp
///
/// CODIR-local dead code elimination for isolated codelet bodies.
///==========================================================================///
...
#define GEN_PASS_DEF_CODIRCODELETDCE
...
struct CodirCodeletDCEPass
    : public codir::impl::CodirCodeletDCEBase<CodirCodeletDCEPass> {
...
std::unique_ptr<Pass> mlir::carts::codir::createCodirCodeletDCEPass() {
  return std::make_unique<CodirCodeletDCEPass>();
}
