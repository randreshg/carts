...
module {
  func.func @mismatched_partial_reduction_dep_maps(%A: memref<128x128xf64>, %x: memref<128xf64>, %y: memref<128xf64>, %base: index) {
    ...
    scf.for %i = %base to %c128 step %c16 {
      codir.codelet deps(%y, %A, %x : memref<128xf64>, memref<128x128xf64>, memref<128xf64>)
          ...
          attributes {dep_modes = [#codir.access_mode<readwrite>, #codir.access_mode<read>, #codir.access_mode<read>],
                      ...
                      partial_reduction,
                      partial_reduction_dep_result_dim_maps = [[0], [0, 1], [-1]],
...
// CHECK: existing partial-reduction dep/result dimension maps does not match recomputed CODIR reduction plan
