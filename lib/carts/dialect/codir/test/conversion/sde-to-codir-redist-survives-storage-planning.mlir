// RUN: %carts-compile %s --pass-pipeline='builtin.module(convert-sde-to-codir,codir-codelet-opt,reduction-planning,storage-planning,verify-codir)' 2>&1 | %FileCheck %s

// The movement family CODIR consumes from a committed sde.redist must survive
// the rest of the CODIR planning pipeline: storage-planning preserves the
