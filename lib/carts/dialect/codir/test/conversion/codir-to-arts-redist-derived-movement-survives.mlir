...
// RUN: %carts-compile %s --pass-pipeline='builtin.module(convert-sde-to-codir,verify-codir,codir-codelet-dce,reduction-dep-mapping,dep-storage-assignment,verify-codir,convert-codir-to-arts,realize-edt-distribution-plan,verify-arts-objects-only)' \
