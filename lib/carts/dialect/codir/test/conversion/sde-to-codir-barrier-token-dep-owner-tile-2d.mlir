...
module {
  ...
  func.func @tokenizes_aligned_owner_tile_write_read_barrier_3d(%A: memref<8x8x8xf32>,
                                                                %B: memref<8x8x8xf32>) {
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %c4 = arith.constant 4 : index
  ...
  func.func @preserves_barrier_for_transposed_owner_tile_window_3d(%A: memref<8x8x8xf32>,
                                                                   %B: memref<8x8x8xf32>) {
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %c4 = arith.constant 4 : index
...
// CHECK: arts.barrier
// CHECK: scf.for
// CHECK-LABEL: func.func @tokenizes_aligned_owner_tile_write_read_barrier_3d
// CHECK: scf.for
// CHECK: arith.divui
// CHECK: arith.remui
// CHECK: arts.db_acquire[<out>]
...
// CHECK: arts.db_acquire[<in>]
// CHECK: arts.edt <task>
// CHECK-LABEL: func.func @preserves_barrier_for_transposed_owner_tile_window_3d
// CHECK: scf.for
// CHECK: arts.edt <task>
// CHECK: arts.barrier
// CHECK: scf.for
