...
// and that unresolved dependency block arguments are rejected before Core.
...
// CHECK: error: 'sde.cu_task' op has unsupported dependency value <block argument> of type '!sde.dep'
// CHECK-SAME: only SDE-materialized codelet tokens may reach Core
