...
// Verify that under the carrier-authoritative model, two consecutive
// elementwise scheduling units are preserved as separate loops.
// Fusion does not fire because the carrier tensor bodies prevent the
// ElementwiseFusion pass from merging them.
