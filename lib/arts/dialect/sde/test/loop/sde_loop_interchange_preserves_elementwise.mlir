...
// Verify that LoopInterchange does not modify elementwise loops. Only
// matmul patterns should be interchanged; elementwise loops with all-parallel
// iterators should pass through unchanged.

// CHECK-LABEL: // -----// IR Dump After LoopInterchange (loop-interchange) //----- //
// CHECK: arts_sde.su_iterate
// CHECK-SAME: classification(<elementwise>)
// CHECK: arts_sde.mu_memref_to_tensor %arg0
// CHECK: arts_sde.mu_memref_to_tensor %arg1
