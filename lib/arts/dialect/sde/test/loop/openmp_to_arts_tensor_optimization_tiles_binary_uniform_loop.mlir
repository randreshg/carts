...
// TENSOR: %[[OUT:.+]] = bufferization.to_tensor %arg2 : memref<128xf64> to tensor<128xf64>
...
// OPT: %[[LHS:.+]] = memref.load %arg0[%[[IV]]] : memref<128xf64>
// OPT: %[[RHS:.+]] = memref.load %arg1[%[[IV]]] : memref<128xf64>
// OPT: %[[SUM:.+]] = arith.addf %[[LHS]], %[[RHS]] : f64
// OPT: memref.store %[[SUM]], %arg2[%[[IV]]] : memref<128xf64>
