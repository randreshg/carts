...
// Verify that a symbolic-trip schedule is refined to static for scalar SDE loops.
// ChunkOpt keeps the refinement attribute-only; no chunk operand is added.
