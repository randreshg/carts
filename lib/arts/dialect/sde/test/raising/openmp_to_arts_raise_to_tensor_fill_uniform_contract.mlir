...
// Verify the SDE carrier-authoritative flow for a write-only elementwise loop:
...
// LINALG: %[[OUT:.+]] = arts_sde.mu_memref_to_tensor %arg0 : memref<128xf64> -> tensor<128xf64>
...
// TENSOR: memref.store %{{.+}}, %arg0[%{{.+}}] : memref<128xf64>
