...
// loop: RaiseToLinalg materializes a transient tensor-backed linalg.generic
// directly with one tensor destination per output, RaiseToTensor is a no-op
// since carriers are already tensor-backed, and ConvertSdeToArts consumes the
...
// LINALG: %[[OUT0:.+]] = bufferization.to_tensor %arg1 : memref<128xf64> to tensor<128xf64>
// LINALG: %[[OUT1:.+]] = bufferization.to_tensor %arg2 : memref<128xf64> to tensor<128xf64>
...
// TENSOR: %[[OUT0:.+]] = bufferization.to_tensor %arg1 : memref<128xf64> to tensor<128xf64>
// TENSOR: %[[OUT1:.+]] = bufferization.to_tensor %arg2 : memref<128xf64> to tensor<128xf64>
