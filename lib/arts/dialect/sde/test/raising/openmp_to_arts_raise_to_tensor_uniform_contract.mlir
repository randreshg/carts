...
// Verify the SDE carrier-authoritative flow for a raiseable elementwise loop:
// RaiseToTensor is a no-op (scalar body still present, no carriers yet),
// RaiseToLinalg creates the carrier-authoritative linalg.generic with
// mu_memref_to_tensor boundary ops (scalar body erased), and ConvertSdeToArts
// lowers back to loop/memref IR.
...
// LINALG: %[[OUT:.+]] = arts_sde.mu_memref_to_tensor %arg1 : memref<128xf64> -> tensor<128xf64>
