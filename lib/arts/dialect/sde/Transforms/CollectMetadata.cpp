...
/// OpenMP transformation. Uses MetadataManager with specialized analyzer
...
/// - CollectMetadataPass: Orchestrates using MetadataManager
///
/// Assumptions:
...
struct CollectMetadataPass
  ...
  void runOnOperation() override {
    ...
    auto manager = std::make_unique<MetadataManager>(context);
...
private:
  ...
  void collectLoopMetadata(ModuleOp module, MetadataManager &manager,
  ...
  void collectMemrefMetadata(ModuleOp module, MetadataManager &manager,
  ...
  void refineLoopMemrefMetadata(ModuleOp module, MetadataManager &manager,
