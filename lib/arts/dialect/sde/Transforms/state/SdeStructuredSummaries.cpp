...
struct SdeStructuredSummariesPass
  ...
  explicit SdeStructuredSummariesPass(sde::SDECostModel *costModel = nullptr)
      : costModel(costModel) {}
...
std::unique_ptr<Pass>
createSdeStructuredSummariesPass(sde::SDECostModel *costModel) {
  return std::make_unique<SdeStructuredSummariesPass>(costModel);
}
