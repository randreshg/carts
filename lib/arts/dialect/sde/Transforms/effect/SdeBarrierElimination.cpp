///==========================================================================///
/// File: SdeBarrierElimination.cpp
///
...
namespace mlir::arts {
#define GEN_PASS_DEF_SDEBARRIERELIMINATION
...
ARTS_DEBUG_SETUP(sde_barrier_elimination);
...
struct SdeBarrierEliminationPass
    : public arts::impl::SdeBarrierEliminationBase<
          SdeBarrierEliminationPass> {
  explicit SdeBarrierEliminationPass(sde::SDECostModel *costModel = nullptr)
      : costModel(costModel) {}
  ...
  void runOnOperation() override {
    ...
    ARTS_INFO("SdeBarrierElimination: eliminated " << eliminated
                                                   << " barrier(s)");
...
std::unique_ptr<Pass>
createSdeBarrierEliminationPass(sde::SDECostModel *costModel) {
  return std::make_unique<SdeBarrierEliminationPass>(costModel);
}
