...
mlir::arts::evaluatePersistentRegionGate(const StructuredKernelPlan &plan,
  ...
  bool isStructuredFamily = plan.family == KernelFamily::Stencil ||
  ...
  gate.costModelPassed = gate.launchOverheadRatio > 0.3 &&
