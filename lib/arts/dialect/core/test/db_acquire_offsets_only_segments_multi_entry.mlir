...
module attributes {arts.runtime_total_nodes = 1 : i64, arts.runtime_total_workers = 4 : i64} {
  func.func @offsets_only_segments_multi_entry() -> i32 {
    ...
    %acq_guid, %acq_ptr = arts.db_acquire[<in>] (%guid : memref<?xi64>, %ptr : memref<?xmemref<?xf64>>) partitioning(<stencil>, indices[], offsets[%c0, %c2], sizes[%c1, %c1]) {partition_offsets_segments = array<i32: 1, 1>, partition_sizes_segments = array<i32: 1, 1>, partition_entry_modes = array<i32: 3, 3>} -> (memref<?xi64>, memref<?xmemref<?xf64>>)
