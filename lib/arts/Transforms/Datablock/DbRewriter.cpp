...
DbRewriter::create(DbAllocOp oldAlloc, ValueRange newOuterSizes,
...
DbRewriter::createElementWiseIndexer(Value elemOffset, Value elemSize,
  ...
  ARTS_DEBUG("  ElementWise indexer: outerRank=" << outerRank
                                                 << ", innerRank=" << innerRank);
...
std::unique_ptr<DbIndexerBase>
DbRewriter::createStencilIndexer(const StencilInfo &info, Value chunkSize,
                                 Value elemOffset, unsigned outerRank,
  ...
  return std::make_unique<DbStencilIndexer>(haloLeft, haloRight, chunkSize,
                                            outerRank, innerRank, elemOffset,
                                            ownedArg, leftHaloArg, rightHaloArg);
}

std::unique_ptr<DbIndexerBase> DbRewriter::createIndexer(
    const DbRewritePlan &plan, Value startChunk, Value elemOffset,
  ...
  ARTS_DEBUG("DbRewriter::createIndexer mode="
             << getRewriterModeName(plan.mode));
