...
def full_feature_lifecycle(
    ...
    tests = g.ask(
        ...
        "Unified design:\n{unified_design}\n\n"
        "Create:\n"
        "- FileCheck lit tests in per-dialect test dirs (e.g. lib/arts/dialect/sde/test/, "
        "lib/arts/dialect/core/test/, lib/arts/dialect/rt/test/) using %carts-compile substitution\n"
