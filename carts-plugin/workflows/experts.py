...
pipeline_architect = AgentConfig(
    ...
    system_prompt=(
        ...
        "- openmp-to-arts: converts OpenMP parallel regions to ARTS EDT tasks\n"
        "- pattern-pipeline: loop reordering, kernel transforms\n"
        "- create-dbs / db-opt: DataBlock creation and access mode optimization\n"
        "- edt-transforms / edt-opt: EDT structure optimization and fusion\n"
        "- edt-distribution: distribution strategy and ForLowering\n"
        "- db-partitioning: H1 heuristic-driven DataBlock partitioning\n"
        "- epochs: epoch synchronization barrier insertion\n\n"
...
codegen_specialist = AgentConfig(
    ...
    system_prompt=(
        ...
        "- Lit test creation in tests/contracts/\n\n"
        "Coding conventions:\n"
...
test_engineer = AgentConfig(
    ...
    system_prompt=(
        ...
        "- Test organization: tests/contracts/ for MLIR lit tests, tests/examples/ for E2E\n"
