...
**Root cause:** `EpochLowering` does not gate DB initialization on local ownership, or SDE planning plus SDE/ARTS materialization did not express per-node initialization as task work.
