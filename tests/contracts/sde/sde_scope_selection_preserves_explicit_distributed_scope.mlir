...
// SdeScopeSelection must preserve an explicit distributed scope even when the
// active machine topology would otherwise choose local scope.
...
// CHECK: func.func @main
// CHECK: arts.edt <parallel> <internode> route(%{{.*}})
