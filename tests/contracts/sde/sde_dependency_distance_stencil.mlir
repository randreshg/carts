...
// Verify that SdeStructuredSummaries stamps per-dimension dependency distances
// derived from neighborhood offsets on stencil loops.
...
// CHECK: } {accessMaxOffsets = [1, 1], accessMinOffsets = [-1, -1], ownerDims = [0, 1], sde.dep_distances = [1, 1], sde.reuse_footprint_bytes = 48 : index, spatialDims = [0, 1], writeFootprint = [1, 1]}
