...
// carrier. RaiseToLinalg must stamp the matmul classification and materialize a
// transient memref-backed linalg.generic, then RaiseToTensor must rewrite that
// carrier to tensor-backed form without inventing tensor.empty for the
...
// LINALG-SAME: ins(%arg0, %arg1, %arg2 : memref<32x32xf32>, memref<32x32xf32>, memref<32x32xf32>)
// LINALG-SAME: outs(%arg2 : memref<32x32xf32>)
