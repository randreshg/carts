...
// RaiseToLinalg materializes a transient memref-backed linalg.generic with no
// inputs, RaiseToTensor rewrites that carrier into tensor-backed form with an
// empty ins() list, and ConvertSdeToArts consumes the carrier chain so
...
// LINALG-SAME: outs(%arg0 : memref<128xf64>)
...
// TENSOR-NOT: outs(%arg0 : memref<128xf64>)
