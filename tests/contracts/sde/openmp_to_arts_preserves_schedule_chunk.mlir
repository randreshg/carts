...
// Verify that an explicit OpenMP chunk size survives into SDE and is still
// present in the SdeChunkOptimization dump. This pass should preserve the
// source chunk instead of synthesizing a new one.
