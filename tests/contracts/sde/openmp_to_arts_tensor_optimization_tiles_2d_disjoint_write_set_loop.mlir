...
// Verify that SdeTensorOptimization now tiles a narrow multi-dimensional
...
// TENSOR: %[[OUT0:.+]] = tensor.empty() : tensor<64x64xf64>
// TENSOR: %[[OUT1:.+]] = tensor.empty() : tensor<64x64xf64>
...
// OPT: scf.for %[[I:.+]] = %[[TILE]] to %[[TILE_UB]] step %c1 {
