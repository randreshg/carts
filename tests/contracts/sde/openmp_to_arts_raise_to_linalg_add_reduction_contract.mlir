...
// transient memref-backed linalg.generic carrier at the SDE layer while the
...
// CHECK: linalg.generic {indexing_maps = [#map, #map1, #map1], iterator_types = ["reduction"]} ins(%arg0, %cast : memref<128xi32>, memref<?xi32>) outs(%cast : memref<?xi32>) {
