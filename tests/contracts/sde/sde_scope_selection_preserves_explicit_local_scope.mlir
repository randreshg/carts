...
// Verify the before/after for explicit SDE scope ownership:
// SdeScopeSelection must preserve an explicit local scope even when the active
// machine topology would otherwise choose distributed scope.
