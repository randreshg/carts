      ...
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        scf.if %17 {
          ...
          ^bb0(%arg1: memref<?xmemref<?x?x?xf32>>, %arg2: memref<?xmemref<?x?x?xf32>>, %arg3: memref<?xmemref<?x?x?x?xf32>>, %arg4: memref<?xmemref<?x?x?x?xf32>>):
            memref.store %cst_0, %alloca_27[%c0] : memref<5xf32>
            memref.store %cst_1, %alloca_27[%c1] : memref<5xf32>
            memref.store %cst_6, %alloca_27[%c2] : memref<5xf32>
            memref.store %cst_2, %alloca_27[%c3] : memref<5xf32>
            memref.store %cst_3, %alloca_27[%c4] : memref<5xf32>
              ...
              scf.for %arg6 = %c4 to %c44 step %c1 {
                ...
                scf.for %arg7 = %c4 to %c44 step %c1 {
                  ...
                  scf.for %arg8 = %c-2 to %c3 step %c1 {
                    ...
                    %143 = memref.load %alloca_27[%142] : memref<5xf32>
                    ...
                    %157 = memref.load %alloca_31[] : memref<f32>
                    %158 = arith.addf %157, %156 : f32
                    memref.store %158, %alloca_31[] : memref<f32>
                  ...
                  %107 = memref.load %alloca_31[] : memref<f32>
                  %108 = arith.mulf %106, %107 : f32
                  %109 = memref.load %alloca_29[] : memref<f32>
                  ...
                  memref.store %118, %alloca_30[] : memref<f32>
                  %119 = memref.load %alloca_32[] : memref<f32>
                  %120 = memref.load %alloca_28[] : memref<f32>
                  %121 = arith.mulf %119, %120 : f32
                  %122 = memref.load %alloca_29[] : memref<f32>
                  %123 = arith.addf %122, %119 : f32
                  %124 = memref.load %alloca_30[] : memref<f32>
                  ...
                  memref.store %cst_6, %alloca_33[] : memref<f32>
                  scf.for %arg8 = %c-2 to %c3 step %c1 {
                    %140 = arith.index_cast %arg8 : index to i32
                    %141 = arith.addi %140, %c2_i32 : i32
                    %142 = arith.index_cast %141 : i32 to index
                    ...
                    %154 = arith.addf %150, %153 : f32
                    %155 = arith.mulf %143, %154 : f32
                    %156 = memref.load %alloca_33[] : memref<f32>
                    %157 = arith.addf %156, %155 : f32
                    memref.store %157, %alloca_33[] : memref<f32>
                  ...
                  %131 = memref.load %alloca_32[] : memref<f32>
                  %132 = memref.load %alloca_33[] : memref<f32>
                  %133 = arith.mulf %131, %132 : f32
                  %134 = memref.load %alloca_29[] : memref<f32>
