module attributes {arts.runtime_config_data = "[ARTS]\0A# Default ARTS configuration for examples (v2 format)\0Aworker_threads=8\0A\0A# Network configuration\0Asender_threads=0\0Areceiver_threads=0\0Aport_count=1\0A\0A# Launcher configuration\0Alauncher=local\0Amaster_node=localhost\0Anode_count=1\0Anodes=localhost\0Adefault_ports=34739\0A\0A# Scheduling\0Aworker_init_deque_size=2048\0Aroute_table_size=16\0A\0A# Debug\0Acore_dump=1\0Acounter_folder=./counters\0A", arts.runtime_static_workers = false, arts.runtime_total_nodes = 1 : i64, arts.runtime_total_workers = 8 : i64, dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @main() -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %33 = arith.maxui %32, %c1_29 : index
    %34 = arith.subi %33, %c1_29 : index
    %35 = arith.addi %c100, %34 : index
    %36 = arith.divui %35, %33 : index
    %37 = arith.maxui %36, %c1_29 : index
    %c1_30 = arith.constant 1 : index
    %38 = arith.maxui %37, %c1_30 : index
    %c100_31 = arith.constant 100 : index
    ...
    %42 = arith.subi %41, %c1_i64_32 : i64
    ...
    scf.for %arg0 = %c0 to %c100 step %c1 {
      scf.for %arg1 = %c0 to %c100 step %c1 {
        ...
        %60 = arith.maxui %38, %c1_52 : index
        %61 = arith.divui %arg0, %60 : index
        %62 = arith.subi %61, %c0_39 : index
        %63 = arith.remui %arg0, %60 : index
        %64 = arts.db_ref %ptr_38[%62] : memref<?xmemref<?x?xf64>> -> memref<?x?xf64>
    ...
    %45 = arts.epoch attributes {arts.pattern_revision = 2 : i64, arts.plan.async_strategy = "blocking", arts.plan.cost.expected_local_work = 0 : i64, arts.plan.cost.relaunch_amortization = 0 : i64, arts.plan.cost.scheduler_overhead = 300 : i64, arts.plan.cost.slice_widening_pressure = 0 : i64, arts.plan.iteration_topology = "owner_strip", arts.plan.kernel_family = "uniform", arts.plan.repetition_structure = "none", depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32} {
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        scf.if %55 {
          ...
          %65 = arith.maxui %7, %c1_50 : index
          %66 = arith.muli %13, %65 : index
          %67 = arith.divui %50, %65 : index
          %68 = arith.addi %50, %c13 : index
          %69 = arith.subi %68, %c1_50 : index
          %70 = arith.divui %69, %65 : index
          %71 = arith.subi %13, %c1_50 : index
          %72 = arith.cmpi ugt, %67, %71 : index
          %73 = arith.minui %70, %71 : index
          %74 = arith.select %72, %70, %73 : index
          %75 = arith.subi %74, %67 : index
          %76 = arith.addi %75, %c1_50 : index
          %77 = arith.select %72, %c0_51, %67 : index
          %78 = arith.select %72, %c0_51, %76 : index
          %guid_52, %ptr_53 = arts.db_acquire[<out>] (%guid : memref<?xi64>, %ptr : memref<?xmemref<?x?xf64>>) partitioning(<block>, offsets[%50], sizes[%c13]), offsets[%77], sizes[%c1_50] {arts.pattern_revision = 2 : i64, depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32, preserve_dep_edge = #arts.preserve_dep_edge, stencil_block_shape = [100, 13], stencil_owner_dims = [1]} -> (memref<?xi64>, memref<?xmemref<?x?xf64>>)
          arts.lowering_contract(%ptr_53 : memref<?xmemref<?x?xf64>>) pattern(<depPattern = <uniform>, distributionKind = <block>, distributionPattern = <uniform>, distributionVersion = 1 : i64, revision = 2 : i64>) block_shape[%c100] contract(<ownerDims = [1]>)
          arts.edt <task> <intranode> route(%c-1_i32) (%ptr_53) : memref<?xmemref<?x?xf64>> attributes {arts.id = 212 : i64, arts.pattern_revision = 2 : i64, arts.plan.async_strategy = "blocking", arts.plan.cost.expected_local_work = 0 : i64, arts.plan.cost.relaunch_amortization = 0 : i64, arts.plan.cost.scheduler_overhead = 300 : i64, arts.plan.cost.slice_widening_pressure = 0 : i64, arts.plan.iteration_topology = "owner_strip", arts.plan.kernel_family = "uniform", arts.plan.repetition_structure = "none", depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32, stencil_block_shape = [100, 13]} {
          ^bb0(%arg1: memref<?xmemref<?x?xf64>>):
            %c1_54 = arith.constant 1 : index
            %c0_55 = arith.constant 0 : index
            %79 = arith.maxui %7, %c1_54 : index
            %c0_56 = arith.constant 0 : index
            %c13_57 = arith.constant 13 : index
            %80 = arith.muli %arg0, %c13_57 : index
            %c1_58 = arith.constant 1 : index
            %81 = arith.maxui %c13_57, %c1_58 : index
            %c1_59 = arith.constant 1 : index
            %82 = arith.maxui %81, %c1_59 : index
            %83 = arith.divui %80, %82 : index
            %84 = arith.select %72, %c0_56, %83 : index
            memref.store %4, %alloca_43[] : memref<f64>
            ...
            scf.for %arg2 = %87 to %90 step %c1 {
              ...
              memref.store %94, %alloca_43[] : memref<f64>
              ...
              scf.for %arg3 = %c0 to %c100 step %c1 {
                ...
                scf.if %103 {
                  ...
                  %115 = arts.db_ref %arg1[%c0_55] : memref<?xmemref<?x?xf64>> -> memref<?x?xf64>
                  ...
                  %c1_60 = arith.constant 1 : index
                  %115 = arith.maxui %79, %c1_60 : index
                  %c0_61 = arith.constant 0 : index
                  %c1_62 = arith.constant 1 : index
                  %c-1 = arith.constant -1 : index
                  ...
                  %121 = arts.db_ref %arg1[%c0_55] : memref<?xmemref<?x?xf64>> -> memref<?x?xf64>
            ...
            } {arts.id = 211 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = true, hasReductions = false, tripCount = 0 : i64, nestingLevel = 1 : i64, hasInterIterationDeps = false, memrefsWithLoopCarriedDeps = 0 : i64, parallelClassification = 2 : i64, locationKey = "poisson-for.c:114:3">, arts.metadata_provenance = "exact"}
    ...
    scf.for %arg0 = %c0 to %c100 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c100 step %c1 {
        ...
        scf.if %55 {
          ...
          %c1_51 = arith.constant 1 : index
          %62 = arith.maxui %38, %c1_51 : index
          %63 = arith.divui %arg0, %62 : index
          %64 = arith.subi %63, %c0_40 : index
          %65 = arith.remui %arg0, %62 : index
          %66 = arts.db_ref %ptr_38[%64] : memref<?xmemref<?x?xf64>> -> memref<?x?xf64>
          memref.store %61, %66[%65, %arg1] : memref<?x?xf64>
        } else {
          %c1_50 = arith.constant 1 : index
          %56 = arith.maxui %38, %c1_50 : index
          %57 = arith.divui %arg0, %56 : index
          %58 = arith.subi %57, %c0_41 : index
          %59 = arith.remui %arg0, %56 : index
          %60 = arts.db_ref %ptr_38[%58] : memref<?xmemref<?x?xf64>> -> memref<?x?xf64>
    ...
    scf.for %arg0 = %c1 to %c11 step %c1 {
      ...
      scf.if %50 {
        ...
        %57 = arts.epoch attributes {arts.pattern_revision = 2 : i64, arts.plan.async_strategy = "cps_chain", arts.plan.cost.expected_local_work = 5000000 : i64, arts.plan.cost.relaunch_amortization = 1000 : i64, arts.plan.cost.scheduler_overhead = 300 : i64, arts.plan.cost.slice_widening_pressure = 0 : i64, arts.plan.iteration_topology = "owner_strip", arts.plan.kernel_family = "uniform", arts.plan.repetition_structure = "full_timestep", depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32} {
          scf.for %arg1 = %c0 to %56 step %c1 {
            ...
            scf.if %73 {
              %c1_50 = arith.constant 1 : index
              %c0_51 = arith.constant 0 : index
              %guid_52, %ptr_53 = arts.db_acquire[<in>] (%guid_37 : memref<?xi64>, %ptr_38 : memref<?xmemref<?x?xf64>>) partitioning(<coarse>), offsets[%c0_51], sizes[%44] {arts.pattern_revision = 2 : i64, depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32, stencil_block_shape = [13, 100], stencil_owner_dims = [0]} -> (memref<?xi64>, memref<?xmemref<?x?xf64>>)
              arts.lowering_contract(%ptr_53 : memref<?xmemref<?x?xf64>>) pattern(<depPattern = <uniform>, distributionKind = <block>, distributionPattern = <uniform>, distributionVersion = 1 : i64, revision = 2 : i64>) block_shape[%c13] contract(<ownerDims = [0]>)
              %74 = arith.maxui %68, %c1 : index
              %75 = arith.divui %67, %c100 : index
              %76 = arith.addi %67, %74 : index
              %77 = arith.subi %76, %c1 : index
              %78 = arith.divui %77, %c100 : index
              %79 = arith.cmpi ugt, %75, %c0 : index
              %80 = arith.select %79, %78, %c0 : index
              %81 = arith.subi %80, %75 : index
              %82 = arith.addi %81, %c1 : index
              %83 = arith.select %79, %c0, %75 : index
              %84 = arith.select %79, %c0, %82 : index
              %c0_54 = arith.constant 0 : index
              %c1_55 = arith.constant 1 : index
              %85 = arith.maxui %21, %c1_55 : index
              %c13_56 = arith.constant 13 : index
              %86 = arith.maxui %c13_56, %c1_55 : index
              %c1_57 = arith.constant 1 : index
              %87 = arith.addi %67, %c1_57 : index
              %88 = arith.divui %87, %85 : index
              %89 = arith.muli %88, %85 : index
              %c0_58 = arith.constant 0 : index
              %c1_59 = arith.constant 1 : index
              %90 = arith.maxui %21, %c1_59 : index
              %91 = arith.muli %30, %90 : index
              %92 = arith.maxui %68, %c1_59 : index
              %93 = arith.divui %67, %90 : index
              %94 = arith.addi %67, %92 : index
              %95 = arith.subi %94, %c1_59 : index
              %96 = arith.divui %95, %90 : index
              %97 = arith.subi %30, %c1_59 : index
              %98 = arith.cmpi ugt, %93, %97 : index
              %99 = arith.minui %96, %97 : index
              %100 = arith.select %98, %96, %99 : index
              %101 = arith.subi %100, %93 : index
              %102 = arith.addi %101, %c1_59 : index
              %103 = arith.select %98, %c0_58, %93 : index
              %104 = arith.select %98, %c0_58, %102 : index
              %guid_60, %ptr_61 = arts.db_acquire[<out>] (%guid_25 : memref<?xi64>, %ptr_26 : memref<?xmemref<?x?xf64>>) partitioning(<block>), offsets[%103], sizes[%104] element_offsets[%67] element_sizes[%68] {arts.pattern_revision = 2 : i64, depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32, preserve_dep_edge = #arts.preserve_dep_edge, stencil_block_shape = [13, 100], stencil_owner_dims = [0]} -> (memref<?xi64>, memref<?xmemref<?x?xf64>>)
              arts.lowering_contract(%ptr_61 : memref<?xmemref<?x?xf64>>) pattern(<depPattern = <uniform>, distributionKind = <block>, distributionPattern = <uniform>, distributionVersion = 1 : i64, revision = 2 : i64>) block_shape[%c13] contract(<ownerDims = [0]>)
              arts.edt <task> <intranode> route(%c-1_i32) (%ptr_53, %ptr_61) : memref<?xmemref<?x?xf64>>, memref<?xmemref<?x?xf64>> attributes {arts.id = 213 : i64, arts.pattern_revision = 2 : i64, arts.plan.async_strategy = "cps_chain", arts.plan.cost.expected_local_work = 5000000 : i64, arts.plan.cost.relaunch_amortization = 1000 : i64, arts.plan.cost.scheduler_overhead = 300 : i64, arts.plan.cost.slice_widening_pressure = 0 : i64, arts.plan.iteration_topology = "owner_strip", arts.plan.kernel_family = "uniform", arts.plan.repetition_structure = "full_timestep", depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32, stencil_block_shape = [13, 100]} {
              ^bb0(%arg2: memref<?xmemref<?x?xf64>>, %arg3: memref<?xmemref<?x?xf64>>):
                %c1_62 = arith.constant 1 : index
                %c0_63 = arith.constant 0 : index
                %105 = arith.maxui %38, %c1_62 : index
                %c0_64 = arith.constant 0 : index
                %c1_65 = arith.constant 1 : index
                %c0_66 = arith.constant 0 : index
                %106 = arith.maxui %21, %c1_65 : index
                %107 = arith.select %98, %c0_58, %93 : index
                memref.store %46, %alloca_48[] : memref<i32>
                memref.store %c100_i32, %alloca_48[] : memref<i32>
                %108 = memref.load %alloca_48[] : memref<i32>
                %109 = arith.index_cast %108 : i32 to index
                %110 = arith.addi %109, %c12 : index
                %111 = arith.divui %110, %c13 : index
                %112 = arith.divui %111, %c8 : index
                %113 = arith.muli %arg1, %112 : index
                %114 = arith.muli %113, %c13 : index
                %115 = arith.subi %c0, %114 : index
                %116 = arith.subi %109, %114 : index
                %117 = arith.cmpi slt, %115, %c0 : index
                %118 = arith.select %117, %c0, %115 : index
                %119 = arith.cmpi slt, %116, %c0 : index
                %120 = arith.select %119, %c0, %116 : index
                %121 = arith.minui %120, %72 : index
                scf.for %arg4 = %118 to %121 step %c1 {
                  %122 = arith.addi %114, %arg4 : index
                  scf.for %arg5 = %c0 to %c100 step %c1 {
                    %c1_67 = arith.constant 1 : index
                    %123 = arith.maxui %105, %c1_67 : index
                    %124 = arith.divui %122, %123 : index
                    %125 = arith.subi %124, %c0_64 : index
                    %126 = arith.remui %122, %123 : index
                    %127 = arts.db_ref %arg2[%125] : memref<?xmemref<?x?xf64>> -> memref<?x?xf64>
                    %128 = memref.load %127[%126, %arg5] : memref<?x?xf64>
                    %c1_68 = arith.constant 1 : index
                    %129 = arith.maxui %106, %c1_68 : index
                    %130 = arith.divui %122, %129 : index
                    %131 = arith.subi %130, %107 : index
                    %132 = arith.remui %122, %129 : index
                    %133 = arts.db_ref %arg3[%131] : memref<?xmemref<?x?xf64>> -> memref<?x?xf64>
                    memref.store %128, %133[%132, %arg5] : memref<?x?xf64>
        ...
        memref.store %true, %alloca_47[] : memref<i1>
        memref.store %c100_i32, %alloca_45[] : memref<i32>
        %58 = memref.load %alloca_45[] : memref<i32>
        ...
        %64 = arts.epoch attributes {arts.pattern_revision = 2 : i64, arts.plan.async_strategy = "cps_chain", arts.plan.cost.expected_local_work = 30087500 : i64, arts.plan.cost.relaunch_amortization = 1000 : i64, arts.plan.cost.scheduler_overhead = 300 : i64, arts.plan.cost.slice_widening_pressure = 0 : i64, arts.plan.iteration_topology = "owner_strip", arts.plan.kernel_family = "stencil", arts.plan.repetition_structure = "full_timestep", depPattern = #arts.dep_pattern<stencil>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<stencil>, distribution_version = 1 : i32} {
          scf.for %arg1 = %c0 to %63 step %c1 {
            ...
            scf.if %73 {
              ...
              %c1_50 = arith.constant 1 : index
              %c0_51 = arith.constant 0 : index
              %guid_52, %ptr_53 = arts.db_acquire[<in>] (%guid : memref<?xi64>, %ptr : memref<?xmemref<?x?xf64>>) partitioning(<block>, offsets[%77], sizes[%82]), offsets[%c0_51], sizes[%13] element_offsets[%77] element_sizes[%82] {arts.pattern_revision = 2 : i64, depPattern = #arts.dep_pattern<stencil>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<stencil>, distribution_version = 1 : i32, preserve_dep_edge = #arts.preserve_dep_edge, stencil_block_shape = [13, 100], stencil_owner_dims = [0]} -> (memref<?xi64>, memref<?xmemref<?x?xf64>>)
              arts.lowering_contract(%ptr_53 : memref<?xmemref<?x?xf64>>) pattern(<depPattern = <stencil>, distributionKind = <block>, distributionPattern = <stencil>, distributionVersion = 1 : i64, revision = 2 : i64>) block_shape[%c13] contract(<ownerDims = [0], narrowableDep = true>)
              ...
              %c1_54 = arith.constant 1 : index
              %c0_55 = arith.constant 0 : index
              %guid_56, %ptr_57 = arts.db_acquire[<out>] (%guid_37 : memref<?xi64>, %ptr_38 : memref<?xmemref<?x?xf64>>) partitioning(<block>, offsets[%67], sizes[%68]), offsets[%c0_55], sizes[%44] {arts.pattern_revision = 2 : i64, depPattern = #arts.dep_pattern<stencil>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<stencil>, distribution_version = 1 : i32, preserve_dep_edge = #arts.preserve_dep_edge, stencil_block_shape = [13, 100], stencil_owner_dims = [0]} -> (memref<?xi64>, memref<?xmemref<?x?xf64>>)
              arts.lowering_contract(%ptr_57 : memref<?xmemref<?x?xf64>>) pattern(<depPattern = <stencil>, distributionKind = <block>, distributionPattern = <stencil>, distributionVersion = 1 : i64, revision = 2 : i64>) block_shape[%c13] contract(<ownerDims = [0]>)
              %c0_58 = arith.constant 0 : index
              %c1_59 = arith.constant 1 : index
              %105 = arith.maxui %21, %c1_59 : index
              %c13_60 = arith.constant 13 : index
              %106 = arith.maxui %c13_60, %c1_59 : index
              %c1_61 = arith.constant 1 : index
              %107 = arith.addi %77, %c1_61 : index
              %108 = arith.divui %107, %105 : index
              %109 = arith.muli %108, %105 : index
              %c0_62 = arith.constant 0 : index
              %c1_63 = arith.constant 1 : index
              %110 = arith.maxui %21, %c1_63 : index
              %111 = arith.muli %30, %110 : index
              %112 = arith.maxui %82, %c1_63 : index
              %113 = arith.divui %77, %110 : index
              %114 = arith.addi %77, %112 : index
              %115 = arith.subi %114, %c1_63 : index
              %116 = arith.divui %115, %110 : index
              %117 = arith.subi %30, %c1_63 : index
              ...
              %122 = arith.addi %121, %c1_63 : index
              %123 = arith.select %118, %c0_62, %113 : index
              %124 = arith.select %118, %c0_62, %122 : index
              %guid_64, %ptr_65 = arts.db_acquire[<in>] (%guid_25 : memref<?xi64>, %ptr_26 : memref<?xmemref<?x?xf64>>) partitioning(<block>), offsets[%123], sizes[%124] element_offsets[%77] element_sizes[%82] {arts.pattern_revision = 2 : i64, depPattern = #arts.dep_pattern<stencil>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<stencil>, distribution_version = 1 : i32, preserve_dep_edge = #arts.preserve_dep_edge, stencil_block_shape = [13, 100], stencil_owner_dims = [0]} -> (memref<?xi64>, memref<?xmemref<?x?xf64>>)
              arts.lowering_contract(%ptr_65 : memref<?xmemref<?x?xf64>>) pattern(<depPattern = <stencil>, distributionKind = <block>, distributionPattern = <stencil>, distributionVersion = 1 : i64, revision = 2 : i64>) block_shape[%c13] contract(<ownerDims = [0], narrowableDep = true>)
              arts.edt <task> <intranode> route(%c-1_i32) (%ptr_53, %ptr_57, %ptr_65) : memref<?xmemref<?x?xf64>>, memref<?xmemref<?x?xf64>>, memref<?xmemref<?x?xf64>> attributes {arts.id = 214 : i64, arts.pattern_revision = 2 : i64, arts.plan.async_strategy = "cps_chain", arts.plan.cost.expected_local_work = 30087500 : i64, arts.plan.cost.relaunch_amortization = 1000 : i64, arts.plan.cost.scheduler_overhead = 300 : i64, arts.plan.cost.slice_widening_pressure = 0 : i64, arts.plan.iteration_topology = "owner_strip", arts.plan.kernel_family = "stencil", arts.plan.repetition_structure = "full_timestep", depPattern = #arts.dep_pattern<stencil>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<stencil>, distribution_version = 1 : i32, stencil_block_shape = [13, 100]} {
              ^bb0(%arg2: memref<?xmemref<?x?xf64>>, %arg3: memref<?xmemref<?x?xf64>>, %arg4: memref<?xmemref<?x?xf64>>):
                %c1_66 = arith.constant 1 : index
                %c0_67 = arith.constant 0 : index
                %125 = arith.maxui %38, %c1_66 : index
                %c0_68 = arith.constant 0 : index
                %c1_69 = arith.constant 1 : index
                %c0_70 = arith.constant 0 : index
                %126 = arith.maxui %21, %c1_69 : index
                %127 = arith.select %118, %c0_62, %113 : index
                %c1_71 = arith.constant 1 : index
                %c0_72 = arith.constant 0 : index
                %128 = arith.maxui %7, %c1_71 : index
                %c0_73 = arith.constant 0 : index
                memref.store %46, %alloca_49[] : memref<i32>
                memref.store %c100_i32, %alloca_49[] : memref<i32>
                %129 = memref.load %alloca_49[] : memref<i32>
                ...
                scf.for %arg5 = %139 to %142 step %c1 {
                  ...
                  scf.for %arg6 = %c0 to %c100 step %c1 {
                    ...
                    scf.if %154 {
                      ...
                      %155 = arith.maxui %128, %c1_74 : index
                      %156 = arith.divui %arg6, %155 : index
                      %157 = arith.subi %156, %c0_73 : index
                      ...
                      %161 = arith.maxui %125, %c1_75 : index
                      %162 = arith.divui %143, %161 : index
                      %163 = arith.subi %162, %c0_68 : index
                      ...
                      %c1_74 = arith.constant 1 : index
                      %155 = arith.maxui %126, %c1_74 : index
                      ...
                      %c1_75 = arith.constant 1 : index
                      %163 = arith.maxui %126, %c1_75 : index
                      ...
                      %172 = arith.maxui %126, %c1_76 : index
                      ...
                      %179 = arith.maxui %126, %c1_77 : index
                      ...
                      %186 = arith.maxui %128, %c1_78 : index
                      %187 = arith.divui %arg6, %186 : index
                      %188 = arith.subi %187, %c0_73 : index
                      ...
                      %196 = arith.maxui %125, %c1_79 : index
                      %197 = arith.divui %143, %196 : index
                      %198 = arith.subi %197, %c0_68 : index
                ...
                } {arts.id = 92 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = true, hasReductions = false, tripCount = 0 : i64, nestingLevel = 2 : i64, hasInterIterationDeps = false, memrefsWithLoopCarriedDeps = 0 : i64, parallelClassification = 2 : i64, locationKey = "poisson-for.c:132:5">, arts.metadata_provenance = "exact"}
                arts.db_release(%arg2) : memref<?xmemref<?x?xf64>>
                arts.db_release(%arg3) : memref<?xmemref<?x?xf64>>
    ...
    scf.for %arg0 = %c0 to %c100 step %c1 {
      %c1_50 = arith.constant 1 : index
      %50 = arith.maxui %38, %c1_50 : index
      %51 = arith.divui %arg0, %50 : index
      %52 = arith.subi %51, %c0_42 : index
      %53 = arith.remui %arg0, %50 : index
      %54 = arts.db_ref %ptr_38[%52] : memref<?xmemref<?x?xf64>> -> memref<?x?xf64>
    ...
    arts.db_free(%ptr_38) : memref<?xmemref<?x?xf64>>
