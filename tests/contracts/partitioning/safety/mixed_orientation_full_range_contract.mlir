// RUN: sh -c 'CARTS_COMPILE_WORKDIR=%t.compile %S/../../../../tools/carts compile %S/../../../examples/mixed_orientation/poisson_mixed_orientation.c --pipeline concurrency-opt --arts-config %S/../../../examples/arts.cfg || true' | %FileCheck %s
