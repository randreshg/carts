...
// Test that a 2D jacobi-like stencil kernel produces a structured kernel plan
// with family "stencil" and owner_strip topology after edt-distribution.
// The plan pass runs before EdtDistribution within the edt-distribution stage.

// CHECK-DAG: arts.plan.kernel_family = "stencil"
// CHECK-DAG: arts.plan.iteration_topology = "owner_strip"
