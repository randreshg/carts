...
//   2. cps_iter_counter_param_idx is present on continuation EDTs
//   3. cps_outer_epoch_param_idx is present on continuation EDTs
//   4. continuation_for_epoch marks the EDT as continuation-managed
