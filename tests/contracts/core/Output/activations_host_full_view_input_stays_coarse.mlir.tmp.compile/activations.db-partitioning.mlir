      ...
      scf.for %arg2 = %c0 to %c2 step %c1 {
        ...
        scf.if %103 {
          ...
          ^bb0(%arg3: memref<?xmemref<?xf32>>, %arg4: memref<?xmemref<?xf32>>, %arg5: memref<?xmemref<?xf32>>, %arg6: memref<?xmemref<?xf32>>, %arg7: memref<?xmemref<?xf32>>, %arg8: memref<?xmemref<?xf32>>, %arg9: memref<?xmemref<?xf32>>):
            ...
            %211 = arith.maxui %70, %c1_164 : index
            ...
            %219 = arith.select %204, %c0_166, %218 : index
            %c1_170 = arith.constant 1 : index
            %c0_171 = arith.constant 0 : index
            %220 = arith.maxui %60, %c1_170 : index
            ...
            %228 = arith.select %190, %c0_172, %227 : index
            %c1_176 = arith.constant 1 : index
            %c0_177 = arith.constant 0 : index
            %229 = arith.maxui %10, %c1_176 : index
            ...
            %237 = arith.select %120, %c0_178, %236 : index
            %c1_182 = arith.constant 1 : index
            %c0_183 = arith.constant 0 : index
            %238 = arith.maxui %50, %c1_182 : index
            ...
            %246 = arith.select %176, %c0_184, %245 : index
            %c1_188 = arith.constant 1 : index
            %c0_189 = arith.constant 0 : index
            %247 = arith.maxui %20, %c1_188 : index
            ...
            %255 = arith.select %134, %c0_190, %254 : index
            %c1_194 = arith.constant 1 : index
            %c0_195 = arith.constant 0 : index
            %256 = arith.maxui %30, %c1_194 : index
            ...
            %264 = arith.select %148, %c0_196, %263 : index
            %c1_200 = arith.constant 1 : index
            %c0_201 = arith.constant 0 : index
            %265 = arith.maxui %40, %c1_200 : index
            ...
            %273 = arith.select %162, %c0_202, %272 : index
            ...
            scf.for %arg10 = %276 to %279 step %c1 {
              ...
              %288 = arith.maxui %229, %c1_206 : index
              ...
              %293 = arith.subi %290, %237 : index
              %294 = arts.db_ref %arg3[%c0_177] : memref<?xmemref<?xf32>> -> memref<?xf32>
              ...
              %296 = arith.maxui %247, %c1_209 : index
              ...
              %301 = arith.subi %298, %255 : index
              %302 = arts.db_ref %arg4[%c0_189] : memref<?xmemref<?xf32>> -> memref<?xf32>
              ...
              %305 = arith.maxui %256, %c1_213 : index
              ...
              %310 = arith.subi %307, %264 : index
              %311 = arts.db_ref %arg5[%c0_195] : memref<?xmemref<?xf32>> -> memref<?xf32>
        ...
        scf.if %103 {
          ...
          ^bb0(%arg3: memref<?xmemref<?xf32>>, %arg4: memref<?xmemref<?xf32>>, %arg5: memref<?xmemref<?xf32>>, %arg6: memref<?xmemref<?xf32>>, %arg7: memref<?xmemref<?xf32>>, %arg8: memref<?xmemref<?xf32>>, %arg9: memref<?xmemref<?xf32>>):
            ...
            scf.for %arg10 = %276 to %279 step %c1 {
              ...
              %c1_206 = arith.constant 1 : index
              %295 = arith.maxui %265, %c1_206 : index
              %c0_207 = arith.constant 0 : index
              %c1_208 = arith.constant 1 : index
              %c-1 = arith.constant -1 : index
              ...
              %300 = arith.subi %297, %273 : index
              %301 = arts.db_ref %arg6[%c0_201] : memref<?xmemref<?xf32>> -> memref<?xf32>
        ...
        scf.if %103 {
          ...
          ^bb0(%arg3: memref<?xmemref<?xf32>>, %arg4: memref<?xmemref<?xf32>>, %arg5: memref<?xmemref<?xf32>>, %arg6: memref<?xmemref<?xf32>>, %arg7: memref<?xmemref<?xf32>>, %arg8: memref<?xmemref<?xf32>>, %arg9: memref<?xmemref<?xf32>>):
            ...
            scf.for %arg10 = %276 to %279 step %c1 {
              ...
              %c1_206 = arith.constant 1 : index
              %291 = arith.maxui %238, %c1_206 : index
              %c0_207 = arith.constant 0 : index
              %c1_208 = arith.constant 1 : index
              %c-1 = arith.constant -1 : index
              ...
              %296 = arith.subi %293, %246 : index
              %297 = arts.db_ref %arg7[%c0_183] : memref<?xmemref<?xf32>> -> memref<?xf32>
              ...
              %c1_209 = arith.constant 1 : index
              %302 = arith.maxui %220, %c1_209 : index
              %c0_210 = arith.constant 0 : index
              %c1_211 = arith.constant 1 : index
              %c-1_212 = arith.constant -1 : index
              ...
              %307 = arith.subi %304, %228 : index
              %308 = arts.db_ref %arg8[%c0_171] : memref<?xmemref<?xf32>> -> memref<?xf32>
        ...
        scf.if %103 {
          ...
          ^bb0(%arg3: memref<?xmemref<?xf32>>, %arg4: memref<?xmemref<?xf32>>, %arg5: memref<?xmemref<?xf32>>, %arg6: memref<?xmemref<?xf32>>, %arg7: memref<?xmemref<?xf32>>, %arg8: memref<?xmemref<?xf32>>, %arg9: memref<?xmemref<?xf32>>):
            ...
            scf.for %arg10 = %276 to %279 step %c1 {
              ...
              %c1_206 = arith.constant 1 : index
              %287 = arith.maxui %211, %c1_206 : index
              %c0_207 = arith.constant 0 : index
              %c1_208 = arith.constant 1 : index
              %c-1 = arith.constant -1 : index
              ...
              %292 = arith.subi %289, %219 : index
              %293 = arts.db_ref %arg9[%c0_165] : memref<?xmemref<?xf32>> -> memref<?xf32>
