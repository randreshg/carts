...
// Test that plan attributes survive through the post-db-refinement stage.
// A 2D jacobi-like stencil kernel should retain both plan family and
// iteration topology after contract validation and DB refinement.

// CHECK-DAG: arts.plan.kernel_family = "stencil"
// CHECK-DAG: arts.plan.iteration_topology
