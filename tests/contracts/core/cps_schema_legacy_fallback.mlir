...
// Test that elementwise kernels classified as uniform by RaiseToLinalg
// produce valid IR through post-db-refinement. The uniform plan path
// must produce correct lowering contracts and distribution.
//
