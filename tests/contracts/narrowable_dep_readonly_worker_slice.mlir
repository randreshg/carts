...
// CHECK: arts.db_acquire[<in>] {{.*}}partitioning(<block>, offsets[%[[BLOCK_OFF:.*]]], sizes[%[[BLOCK_SIZE:.*]]]), offsets[%[[BLOCK_OFF]]], sizes[%[[BLOCK_SIZE]]] element_offsets[%[[BLOCK_OFF]]] element_sizes[%[[BLOCK_SIZE]]]
