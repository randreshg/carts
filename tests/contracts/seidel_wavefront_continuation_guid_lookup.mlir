...
// Verify that continuation lowering keeps rank-2 Seidel DB-guid dependencies
...
// CHECK: %[[GUID_ADDR:.+]] = llvm.getelementptr %[[GUID_RAW]][%[[LINEAR_I64]]] : (!llvm.ptr, i64) -> !llvm.ptr, i64
// CHECK: %[[GUID_VALUE:.+]] = llvm.load %[[GUID_ADDR]] : !llvm.ptr -> i64
// CHECK: func.call @arts_add_dependence(%[[GUID_VALUE]], %{{.+}}, %{{.+}}, %{{.+}}) : (i64, i64, i32, i32) -> ()
