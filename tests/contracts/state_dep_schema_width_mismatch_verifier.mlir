...
// Repeated epoch loops currently amortize into a blocking epoch/EDT form and
// should do so without emitting any schema mismatch diagnostics.
//
// CHECK-LABEL: func.func @test_state_dep_width
