...
// Test that plan attributes survive through db-partitioning.
// The plan attrs are stamped at edt-distribution and should persist through
// db-partitioning without being removed.

// CHECK: arts.plan.kernel_family
