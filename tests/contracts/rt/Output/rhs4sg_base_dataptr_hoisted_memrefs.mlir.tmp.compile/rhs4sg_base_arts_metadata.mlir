module attributes {arts.runtime_config_data = "[ARTS]\0A# Default ARTS configuration for examples (v2 format)\0Aworker_threads=8\0A\0A# Network configuration\0Asender_threads=0\0Areceiver_threads=0\0Aport_count=1\0A\0A# Launcher configuration\0Alauncher=local\0Amaster_node=localhost\0Anode_count=1\0Anodes=localhost\0Adefault_ports=34739\0A\0A# Scheduling\0Aworker_init_deque_size=2048\0Aroute_table_size=16\0A\0A# Debug\0Acore_dump=1\0Acounter_folder=./counters\0A", arts.runtime_static_workers = false, arts.runtime_total_nodes = 1 : i64, arts.runtime_total_workers = 8 : i64, dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @main() -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %alloc = memref.alloc() {arts.id = 34 : i64, arts.memref = #arts.memref_metadata<rank = 4 : i64, allocationId = "rhs4sg_base.c:116:17", totalAccesses = 16 : i64, readCount = 15 : i64, writeCount = 1 : i64, allAccessesAffine = true, hasNonAffineAccesses = false, memoryFootprint = 768000 : i64, firstUseId = 34 : i64, lastUseId = 35 : i64, hasUniformAccess = false, dominantAccessPattern = 2 : i64, accessedInParallelLoop = true, hasLoopCarriedDeps = false, reuseDistance = 2 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [3, 3, 3, 3], estimatedAccessBytes = 64 : i64>, arts.metadata_provenance = "exact"} : memref<3x40x40x40xf32>
    %alloc_12 = memref.alloc() {arts.id = 36 : i64, arts.memref = #arts.memref_metadata<rank = 4 : i64, allocationId = "rhs4sg_base.c:117:19", totalAccesses = 5 : i64, readCount = 1 : i64, writeCount = 4 : i64, allAccessesAffine = true, hasNonAffineAccesses = false, memoryFootprint = 768000 : i64, firstUseId = 36 : i64, lastUseId = 37 : i64, hasUniformAccess = false, dominantAccessPattern = 0 : i64, accessedInParallelLoop = true, hasLoopCarriedDeps = false, reuseDistance = 6 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [3, 3, 3, 3], estimatedAccessBytes = 20 : i64>, arts.metadata_provenance = "exact"} : memref<3x40x40x40xf32>
    %alloc_13 = memref.alloc() {arts.id = 38 : i64, arts.memref = #arts.memref_metadata<rank = 3 : i64, allocationId = "rhs4sg_base.c:119:17", totalAccesses = 2 : i64, readCount = 1 : i64, writeCount = 1 : i64, allAccessesAffine = true, hasNonAffineAccesses = false, memoryFootprint = 256000 : i64, firstUseId = 38 : i64, lastUseId = 39 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = true, hasLoopCarriedDeps = false, reuseDistance = 11 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [3, 3, 3], estimatedAccessBytes = 8 : i64>, arts.metadata_provenance = "exact"} : memref<40x40x40xf32>
    %alloc_14 = memref.alloc() {arts.id = 40 : i64, arts.memref = #arts.memref_metadata<rank = 3 : i64, allocationId = "rhs4sg_base.c:120:21", totalAccesses = 2 : i64, readCount = 1 : i64, writeCount = 1 : i64, allAccessesAffine = true, hasNonAffineAccesses = false, memoryFootprint = 256000 : i64, firstUseId = 40 : i64, lastUseId = 41 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = true, hasLoopCarriedDeps = false, reuseDistance = 11 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [3, 3, 3], estimatedAccessBytes = 8 : i64>, arts.metadata_provenance = "exact"} : memref<40x40x40xf32>
      ...
      affine.for %arg1 = 0 to 40 {
        scf.for %arg2 = %c0 to %c40 step %c1 {
          scf.for %arg3 = %c0 to %c40 step %c1 {
            ...
            memref.store %21, %alloc[%arg0, %arg1, %arg2, %arg3] : memref<3x40x40x40xf32>
            memref.store %cst_6, %alloc_12[%arg0, %arg1, %arg2, %arg3] : memref<3x40x40x40xf32>
            %22 = affine.load %alloca_15[] : memref<i32>
            %23 = arith.addi %22, %c1_i32 : i32
            affine.store %23, %alloca_15[] : memref<i32>
          } {arts.id = 63 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = false, hasReductions = false, tripCount = 40 : i64, nestingLevel = 3 : i64, hasInterIterationDeps = false, memrefsWithLoopCarriedDeps = 1 : i64, parallelClassification = 3 : i64, locationKey = "rhs4sg_base.c:144:3">, arts.metadata_provenance = "exact"}
        } {arts.id = 65 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = false, hasReductions = false, tripCount = 40 : i64, nestingLevel = 2 : i64, hasInterIterationDeps = false, memrefsWithLoopCarriedDeps = 1 : i64, parallelClassification = 3 : i64, locationKey = "rhs4sg_base.c:144:3">, arts.metadata_provenance = "exact"}
      } {arts.id = 67 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = false, hasReductions = false, tripCount = 40 : i64, nestingLevel = 1 : i64, hasInterIterationDeps = true, memrefsWithLoopCarriedDeps = 1 : i64, parallelClassification = 3 : i64, locationKey = "rhs4sg_base.c:144:3">, arts.metadata_provenance = "exact"}
    ...
    affine.for %arg0 = 0 to 40 {
      scf.for %arg1 = %c0 to %c40 step %c1 {
        scf.for %arg2 = %c0 to %c40 step %c1 {
          ...
          memref.store %16, %alloc_13[%arg0, %arg1, %arg2] : memref<40x40x40xf32>
          %17 = affine.load %alloca_15[] : memref<i32>
          %18 = arith.remsi %17, %c7_i32 : i32
          %19 = arith.sitofp %18 : i32 to f32
          %20 = arith.mulf %19, %cst_10 : f32
          %21 = arith.addf %20, %cst_9 : f32
          memref.store %21, %alloc_14[%arg0, %arg1, %arg2] : memref<40x40x40xf32>
          %22 = affine.load %alloca_15[] : memref<i32>
          %23 = arith.addi %22, %c1_i32 : i32
          affine.store %23, %alloca_15[] : memref<i32>
        } {arts.id = 87 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = false, hasReductions = false, tripCount = 40 : i64, nestingLevel = 2 : i64, hasInterIterationDeps = false, memrefsWithLoopCarriedDeps = 1 : i64, parallelClassification = 3 : i64, locationKey = "rhs4sg_base.c:144:3">, arts.metadata_provenance = "exact"}
      } {arts.id = 89 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = false, hasReductions = false, tripCount = 40 : i64, nestingLevel = 1 : i64, hasInterIterationDeps = false, memrefsWithLoopCarriedDeps = 1 : i64, parallelClassification = 3 : i64, locationKey = "rhs4sg_base.c:144:3">, arts.metadata_provenance = "exact"}
    } {arts.id = 91 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = false, hasReductions = false, tripCount = 40 : i64, nestingLevel = 0 : i64, hasInterIterationDeps = true, memrefsWithLoopCarriedDeps = 1 : i64, parallelClassification = 3 : i64, locationKey = "rhs4sg_base.c:144:3">, arts.metadata_provenance = "exact"}
    ...
    affine.for %arg0 = 4 to 36 {
      affine.for %arg1 = 4 to 36 {
        affine.for %arg2 = 4 to 36 {
          %12 = affine.load %alloc_13[%arg2, %arg1, %arg0] : memref<40x40x40xf32>
          affine.store %12, %alloca_23[] : memref<f32>
          %13 = affine.load %alloc_14[%arg2, %arg1, %arg0] : memref<40x40x40xf32>
          ...
          affine.for %arg3 = -2 to 3 {
            ...
            %51 = affine.load %alloc[0, %arg2 + %arg3, %arg1, %arg0] : memref<3x40x40x40xf32>
            %52 = affine.load %alloc[0, %arg2, %arg1 + %arg3, %arg0] : memref<3x40x40x40xf32>
            %53 = arith.addf %51, %52 : f32
            %54 = affine.load %alloc[0, %arg2, %arg1, %arg0 + %arg3] : memref<3x40x40x40xf32>
          ...
          %14 = affine.load %alloc[0, %arg2 + 1, %arg1, %arg0] : memref<3x40x40x40xf32>
          %15 = affine.load %alloc[0, %arg2 - 1, %arg1, %arg0] : memref<3x40x40x40xf32>
          ...
          affine.store %25, %alloc_12[0, %arg2, %arg1, %arg0] : memref<3x40x40x40xf32>
          affine.store %cst_6, %alloca_19[] : memref<f32>
          affine.for %arg3 = -2 to 3 {
            %50 = affine.load %alloca_24[%arg3 + 2] : memref<5xf32>
            %51 = affine.load %alloc[1, %arg2 + %arg3, %arg1, %arg0] : memref<3x40x40x40xf32>
            %52 = affine.load %alloc[1, %arg2, %arg1 + %arg3, %arg0] : memref<3x40x40x40xf32>
            %53 = arith.addf %51, %52 : f32
            %54 = affine.load %alloc[1, %arg2, %arg1, %arg0 + %arg3] : memref<3x40x40x40xf32>
            %55 = arith.addf %53, %54 : f32
            %56 = arith.mulf %50, %55 : f32
          ...
          %26 = affine.load %alloc[1, %arg2, %arg1 + 1, %arg0] : memref<3x40x40x40xf32>
          %27 = affine.load %alloc[1, %arg2, %arg1 - 1, %arg0] : memref<3x40x40x40xf32>
          ...
          affine.store %37, %alloc_12[1, %arg2, %arg1, %arg0] : memref<3x40x40x40xf32>
          affine.store %cst_6, %alloca_17[] : memref<f32>
          affine.for %arg3 = -2 to 3 {
            %50 = affine.load %alloca_24[%arg3 + 2] : memref<5xf32>
            %51 = affine.load %alloc[2, %arg2 + %arg3, %arg1, %arg0] : memref<3x40x40x40xf32>
            %52 = affine.load %alloc[2, %arg2, %arg1 + %arg3, %arg0] : memref<3x40x40x40xf32>
            %53 = arith.addf %51, %52 : f32
            %54 = affine.load %alloc[2, %arg2, %arg1, %arg0 + %arg3] : memref<3x40x40x40xf32>
            %55 = arith.addf %53, %54 : f32
            %56 = arith.mulf %50, %55 : f32
          ...
          %38 = affine.load %alloc[2, %arg2, %arg1, %arg0 + 1] : memref<3x40x40x40xf32>
          %39 = affine.load %alloc[2, %arg2, %arg1, %arg0 - 1] : memref<3x40x40x40xf32>
          ...
          affine.store %49, %alloc_12[2, %arg2, %arg1, %arg0] : memref<3x40x40x40xf32>
        } {arts.id = 201 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = false, hasReductions = false, tripCount = 32 : i64, nestingLevel = 2 : i64, hasInterIterationDeps = true, memrefsWithLoopCarriedDeps = 8 : i64, parallelClassification = 3 : i64, locationKey = "rhs4sg_base.c:150:5">, arts.metadata_provenance = "exact"}
      } {arts.id = 203 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = false, hasReductions = false, tripCount = 32 : i64, nestingLevel = 1 : i64, hasInterIterationDeps = true, memrefsWithLoopCarriedDeps = 8 : i64, parallelClassification = 3 : i64, locationKey = "rhs4sg_base.c:150:5">, arts.metadata_provenance = "exact"}
    } {arts.id = 205 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = false, hasReductions = false, tripCount = 32 : i64, nestingLevel = 0 : i64, hasInterIterationDeps = true, memrefsWithLoopCarriedDeps = 8 : i64, parallelClassification = 3 : i64, locationKey = "rhs4sg_base.c:150:5">, arts.metadata_provenance = "exact"}
    ...
    affine.for %arg0 = 0 to 40 {
      scf.for %arg1 = %c0 to %c3 step %c1 {
        %12 = memref.load %alloc_12[%arg1, %arg0, %arg0, %arg0] : memref<3x40x40x40xf32>
    ...
    } {arts.id = 210 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = false, hasReductions = false, tripCount = 40 : i64, nestingLevel = 0 : i64, hasInterIterationDeps = true, memrefsWithLoopCarriedDeps = 1 : i64, parallelClassification = 3 : i64, locationKey = "rhs4sg_base.c:162:3">, arts.metadata_provenance = "exact"}
    ...
    memref.dealloc %alloc_14 {arts.id = 41 : i64} : memref<40x40x40xf32>
    memref.dealloc %alloc_13 {arts.id = 39 : i64} : memref<40x40x40xf32>
    memref.dealloc %alloc_12 {arts.id = 37 : i64} : memref<3x40x40x40xf32>
    memref.dealloc %alloc {arts.id = 35 : i64} : memref<3x40x40x40xf32>
    return %c0_i32 : i32
  }
