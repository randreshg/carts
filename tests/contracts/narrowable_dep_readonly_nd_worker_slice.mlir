...
// CHECK: arts.db_acquire[<in>] {{.*}}partitioning(<block>, offsets[%[[ROW_OFF:.*]]], sizes[%[[ROW_SZ:.*]]]), offsets[%[[ROW_OFF]]], sizes[%[[ROW_SZ]]] element_offsets[%[[ROW_OFF]], %{{.+}}] element_sizes[%[[ROW_SZ]], %c64]
