      ...
      scf.for %arg2 = %c0 to %c2 step %c1 {
        ...
        scf.if %46 {
          ...
          ^bb0(%arg3: memref<?xmemref<?xf64>>, %arg4: memref<?xmemref<?x?xf64>>, %arg5: memref<?xmemref<?xf64>>):
            ...
            %124 = arith.maxui %22, %c1_50 : index
            %c0_52 = arith.constant 0 : index
            %c2000_53 = arith.constant 2000 : index
            %125 = arith.muli %arg2, %c2000_53 : index
            %126 = arith.minui %c2000_53, %c2000_53 : index
            %c1_54 = arith.constant 1 : index
            %127 = arith.maxui %126, %c1_54 : index
            %c1_55 = arith.constant 1 : index
            %128 = arith.maxui %127, %c1_55 : index
            %129 = arith.divui %125, %128 : index
            %130 = arith.select %111, %c0_52, %129 : index
            %c1_56 = arith.constant 1 : index
            %c0_57 = arith.constant 0 : index
            %131 = arith.maxui %14, %c1_56 : index
            %c0_58 = arith.constant 0 : index
            %c2000_59 = arith.constant 2000 : index
            %132 = arith.muli %arg2, %c2000_59 : index
            %c1_60 = arith.constant 1 : index
            %133 = arith.subi %132, %c1_60 : index
            %c0_61 = arith.constant 0 : index
            %134 = arith.select %71, %133, %c0_61 : index
            %c4000_62 = arith.constant 4000 : index
            %c1_63 = arith.constant 1 : index
            %135 = arith.maxui %8, %c1_63 : index
            %136 = arith.subi %135, %c1_63 : index
            %137 = arith.addi %c4000_62, %136 : index
            %138 = arith.divui %137, %135 : index
            %139 = arith.maxui %138, %c1_63 : index
            %c1_64 = arith.constant 1 : index
            %140 = arith.maxui %139, %c1_64 : index
            %c1_65 = arith.constant 1 : index
            %141 = arith.maxui %140, %c1_65 : index
            %142 = arith.divui %134, %141 : index
            %143 = arith.select %97, %c0_58, %142 : index
            ...
            scf.for %arg6 = %146 to %149 step %c1 {
              ...
              scf.for %arg7 = %c0 to %c4000 step %c1 {
                ...
                %166 = arith.maxui %131, %c1_73 : index
                %167 = arith.divui %150, %166 : index
                %168 = arith.subi %167, %143 : index
    ...
    %37 = arts.epoch attributes {arts.pattern_revision = 2 : i64, arts.plan.async_strategy = "blocking", arts.plan.cost.expected_local_work = 0 : i64, arts.plan.cost.relaunch_amortization = 0 : i64, arts.plan.cost.scheduler_overhead = 300 : i64, arts.plan.cost.slice_widening_pressure = 0 : i64, arts.plan.iteration_topology = "owner_strip", arts.plan.kernel_family = "uniform", arts.plan.repetition_structure = "none", depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32} {
      scf.for %arg2 = %c0 to %c2 step %c1 {
        ...
        scf.if %46 {
          ...
          %82 = arith.maxui %22, %c1_42 : index
          %83 = arith.muli %28, %82 : index
          %84 = arith.divui %41, %82 : index
          %85 = arith.addi %41, %c2000 : index
          %86 = arith.subi %85, %c1_42 : index
          %87 = arith.divui %86, %82 : index
          %88 = arith.subi %28, %c1_42 : index
          %89 = arith.cmpi ugt, %84, %88 : index
          %90 = arith.minui %87, %88 : index
          %91 = arith.select %89, %87, %90 : index
          %92 = arith.subi %91, %84 : index
          %93 = arith.addi %92, %c1_42 : index
          %94 = arith.select %89, %c0_43, %84 : index
          %95 = arith.select %89, %c0_43, %93 : index
          %guid_44, %ptr_45 = arts.db_acquire[<out>] (%guid_19 : memref<?xi64>, %ptr_20 : memref<?xmemref<?xf64>>) partitioning(<block>, offsets[%41], sizes[%c2000]), offsets[%94], sizes[%c1_42] element_offsets[%41] element_sizes[%c2000] {arts.pattern_revision = 2 : i64, depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32, preserve_dep_edge = #arts.preserve_dep_edge, stencil_block_shape = [2000], stencil_owner_dims = [0]} -> (memref<?xi64>, memref<?xmemref<?xf64>>)
          ...
          arts.edt <task> <intranode> route(%c-1_i32) (%ptr_36, %ptr_41, %ptr_45) : memref<?xmemref<?xf64>>, memref<?xmemref<?x?xf64>>, memref<?xmemref<?xf64>> attributes {arts.id = 85 : i64, arts.pattern_revision = 2 : i64, arts.plan.async_strategy = "blocking", arts.plan.cost.expected_local_work = 0 : i64, arts.plan.cost.relaunch_amortization = 0 : i64, arts.plan.cost.scheduler_overhead = 300 : i64, arts.plan.cost.slice_widening_pressure = 0 : i64, arts.plan.iteration_topology = "owner_strip", arts.plan.kernel_family = "uniform", arts.plan.repetition_structure = "none", depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32, stencil_block_shape = [2000]} {
          ^bb0(%arg3: memref<?xmemref<?xf64>>, %arg4: memref<?xmemref<?x?xf64>>, %arg5: memref<?xmemref<?xf64>>):
            %c1_46 = arith.constant 1 : index
            %c0_47 = arith.constant 0 : index
            %96 = arith.maxui %29, %c1_46 : index
            %c0_48 = arith.constant 0 : index
            %c1_49 = arith.constant 1 : index
            %c0_50 = arith.constant 0 : index
            %97 = arith.maxui %22, %c1_49 : index
            %c0_51 = arith.constant 0 : index
            %c2000_52 = arith.constant 2000 : index
            %98 = arith.muli %arg2, %c2000_52 : index
            %99 = arith.minui %c2000_52, %c2000_52 : index
            %c1_53 = arith.constant 1 : index
            %100 = arith.maxui %99, %c1_53 : index
            %c1_54 = arith.constant 1 : index
            %101 = arith.maxui %100, %c1_54 : index
            %102 = arith.divui %98, %101 : index
            %103 = arith.select %89, %c0_51, %102 : index
            %c1_55 = arith.constant 1 : index
            %c0_56 = arith.constant 0 : index
            %104 = arith.maxui %14, %c1_55 : index
            %c0_57 = arith.constant 0 : index
            %105 = arith.subi %c0, %41 : index
            %106 = arith.cmpi slt, %105, %c0 : index
            %107 = arith.select %106, %c0, %105 : index
            %108 = arith.cmpi slt, %43, %c0 : index
            %109 = arith.select %108, %c0, %43 : index
            %110 = arith.minui %109, %45 : index
            scf.for %arg6 = %107 to %110 step %c1 {
              %111 = arith.addi %41, %arg6 : index
              %c1_58 = arith.constant 1 : index
              %112 = arith.maxui %97, %c1_58 : index
              %c0_59 = arith.constant 0 : index
              %c1_60 = arith.constant 1 : index
              %c-1 = arith.constant -1 : index
              %113 = arith.addi %41, %107 : index
              %114 = arith.divui %113, %112 : index
              %115 = arith.subi %arg6, %107 : index
              %116 = arith.addi %107, %115 : index
              %117 = arith.subi %114, %103 : index
              %118 = arts.db_ref %arg5[%c0_50] : memref<?xmemref<?xf64>> -> memref<?xf64>
              memref.store %cst_1, %118[%arg6] : memref<?xf64>
              scf.for %arg7 = %c0 to %c4000 step %c1 {
                %c1_61 = arith.constant 1 : index
                %119 = arith.maxui %97, %c1_61 : index
                %c0_62 = arith.constant 0 : index
                %c1_63 = arith.constant 1 : index
                %c-1_64 = arith.constant -1 : index
                %120 = arith.addi %41, %107 : index
                %121 = arith.divui %120, %119 : index
                %122 = arith.subi %arg6, %107 : index
                %123 = arith.addi %107, %122 : index
                %124 = arith.subi %121, %103 : index
                %125 = arts.db_ref %arg5[%c0_50] : memref<?xmemref<?xf64>> -> memref<?xf64>
                %126 = memref.load %125[%arg6] : memref<?xf64>
                %c1_65 = arith.constant 1 : index
                %127 = arith.maxui %104, %c1_65 : index
                %128 = arith.divui %arg7, %127 : index
                %129 = arith.subi %128, %c0_57 : index
                %130 = arith.remui %arg7, %127 : index
                %131 = arts.db_ref %arg4[%129] : memref<?xmemref<?x?xf64>> -> memref<?x?xf64>
                %132 = memref.load %131[%130, %111] : memref<?x?xf64>
                %c1_66 = arith.constant 1 : index
                %133 = arith.maxui %96, %c1_66 : index
                %134 = arith.divui %arg7, %133 : index
                %135 = arith.subi %134, %c0_48 : index
                %136 = arith.remui %arg7, %133 : index
                %137 = arts.db_ref %arg3[%135] : memref<?xmemref<?xf64>> -> memref<?xf64>
                %138 = memref.load %137[%136] : memref<?xf64>
                %139 = arith.mulf %132, %138 : f64
                %140 = arith.addf %126, %139 : f64
                %c1_67 = arith.constant 1 : index
                %141 = arith.maxui %97, %c1_67 : index
                %c0_68 = arith.constant 0 : index
                %c1_69 = arith.constant 1 : index
                %c-1_70 = arith.constant -1 : index
                %142 = arith.addi %41, %107 : index
                %143 = arith.divui %142, %141 : index
                %144 = arith.subi %arg6, %107 : index
                %145 = arith.addi %107, %144 : index
                %146 = arith.subi %143, %103 : index
                %147 = arts.db_ref %arg5[%c0_50] : memref<?xmemref<?xf64>> -> memref<?xf64>
                memref.store %140, %147[%arg6] : memref<?xf64>
