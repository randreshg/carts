...
#loc92 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":60:3)
#loc97 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":62:5)
#loc103 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":68:3)
#loc107 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":70:5)
module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func private @kernel_atax(%arg0: i32 loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":54:13), %arg1: i32 loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":54:13), %arg2: memref<?xmemref<?xf64>> loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":54:13), %arg3: memref<?xf64> loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":54:13), %arg4: memref<?xf64> loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":54:13), %arg5: memref<?xf64> loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":54:13)) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    scf.if %true {
      scf.execute_region {
        scf.if %true {
          scf.execute_region {
            affine.for %arg6 loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":60:3) = 0 to %1 {
              scf.execute_region {
                scf.if %true {
                  scf.execute_region {
                    %2 = polygeist.subindex %arg5[%arg6] () : memref<?xf64> -> memref<?xf64> loc(#loc93)
                    affine.store %cst, %2[0] : memref<?xf64> loc(#loc94)
                    scf.yield loc(#loc)
                  } loc(#loc)
                } loc(#loc)
                scf.if %true {
                  scf.execute_region {
                    scf.if %true {
                      scf.execute_region {
                        %2 = polygeist.subindex %arg5[%arg6] () : memref<?xf64> -> memref<?xf64> loc(#loc95)
                        %3 = polygeist.subindex %arg2[%arg6] () : memref<?xmemref<?xf64>> -> memref<?xmemref<?xf64>> loc(#loc96)
                        affine.for %arg7 loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":62:5) = 0 to %0 {
                          scf.execute_region {
                            %4 = affine.load %2[0] : memref<?xf64> loc(#loc98)
                            %5 = affine.load %3[0] : memref<?xmemref<?xf64>> loc(#loc96)
                            %6 = polygeist.subindex %5[%arg7] () : memref<?xf64> -> memref<?xf64> loc(#loc96)
                            %7 = affine.load %6[0] : memref<?xf64> loc(#loc96)
                            %8 = polygeist.subindex %arg3[%arg7] () : memref<?xf64> -> memref<?xf64> loc(#loc99)
                            %9 = affine.load %8[0] : memref<?xf64> loc(#loc99)
                            %10 = arith.mulf %7, %9 : f64 loc(#loc100)
                            %11 = arith.addf %4, %10 : f64 loc(#loc101)
                            affine.store %11, %2[0] : memref<?xf64> loc(#loc102)
                            scf.yield loc(#loc97)
                          } loc(#loc97)
                        } loc(#loc97)
                        scf.yield loc(#loc)
    ...
    scf.if %true {
      scf.execute_region {
        scf.if %true {
          scf.execute_region {
            affine.for %arg6 loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":68:3) = 0 to %0 {
              scf.execute_region {
                scf.if %true {
                  scf.execute_region {
                    %2 = polygeist.subindex %arg4[%arg6] () : memref<?xf64> -> memref<?xf64> loc(#loc104)
                    affine.store %cst, %2[0] : memref<?xf64> loc(#loc105)
                    scf.yield loc(#loc)
                  } loc(#loc)
                } loc(#loc)
                scf.if %true {
                  scf.execute_region {
                    scf.if %true {
                      scf.execute_region {
                        %2 = polygeist.subindex %arg4[%arg6] () : memref<?xf64> -> memref<?xf64> loc(#loc106)
                        affine.for %arg7 loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":70:5) = 0 to %1 {
                          scf.execute_region {
                            %3 = affine.load %2[0] : memref<?xf64> loc(#loc108)
                            %4 = polygeist.subindex %arg2[%arg7] () : memref<?xmemref<?xf64>> -> memref<?xmemref<?xf64>> loc(#loc109)
                            %5 = affine.load %4[0] : memref<?xmemref<?xf64>> loc(#loc109)
                            %6 = polygeist.subindex %5[%arg6] () : memref<?xf64> -> memref<?xf64> loc(#loc109)
                            %7 = affine.load %6[0] : memref<?xf64> loc(#loc109)
                            %8 = polygeist.subindex %arg5[%arg7] () : memref<?xf64> -> memref<?xf64> loc(#loc110)
                            %9 = affine.load %8[0] : memref<?xf64> loc(#loc110)
                            %10 = arith.mulf %7, %9 : f64 loc(#loc111)
                            %11 = arith.addf %3, %10 : f64 loc(#loc112)
                            affine.store %11, %2[0] : memref<?xf64> loc(#loc113)
                            scf.yield loc(#loc107)
                          } loc(#loc107)
                        } loc(#loc107)
                        scf.yield loc(#loc)
                      } loc(#loc)
  ...
  func.func private @carts_kernel_timer_accum(memref<?xi8>) attributes {llvm.linkage = #llvm.linkage<external>} loc(#loc115)
  func.func private @carts_kernel_timer_print(memref<?xi8>) attributes {llvm.linkage = #llvm.linkage<external>} loc(#loc116)
  func.func private @carts_bench_checksum_d(f64) attributes {llvm.linkage = #llvm.linkage<external>} loc(#loc117)
  func.func private @carts_e2e_timer_stop() attributes {llvm.linkage = #llvm.linkage<external>} loc(#loc118)
} loc(#loc)
#loc = loc(unknown)
...
#loc93 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":61:5)
#loc94 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":61:12)
#loc95 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":63:7)
#loc96 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":63:25)
#loc98 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":63:16)
#loc99 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":63:35)
#loc100 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":63:33)
#loc101 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":63:23)
#loc102 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":63:14)
#loc104 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":69:5)
#loc105 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":69:10)
#loc106 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":71:7)
#loc108 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":71:14)
#loc109 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":71:21)
#loc110 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":71:31)
#loc111 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":71:29)
#loc112 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":71:19)
#loc113 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":71:12)
#loc114 = loc("/home/raherrer/projects/carts/external/carts-benchmarks/polybench/atax/atax.c":74:1)
#loc115 = loc("/home/raherrer/projects/carts/.install/carts/include/arts/utils/benchmarks/CartsBenchmarks.h":134:6)
#loc116 = loc("/home/raherrer/projects/carts/.install/carts/include/arts/utils/benchmarks/CartsBenchmarks.h":137:6)
#loc117 = loc("/home/raherrer/projects/carts/.install/carts/include/arts/utils/benchmarks/CartsBenchmarks.h":207:6)
#loc118 = loc("/home/raherrer/projects/carts/.install/carts/include/arts/utils/benchmarks/CartsBenchmarks.h":77:6)
