module attributes {arts.runtime_config_data = "[ARTS]\0A# Contract config for high-thread single-node lowering checks.\0Aworker_threads=64\0A\0A# Network configuration\0Asender_threads=0\0Areceiver_threads=0\0Aport_count=1\0A\0A# Launcher configuration\0Alauncher=local\0Amaster_node=localhost\0Anode_count=1\0Anodes=localhost\0Adefault_ports=34739\0A\0A# Scheduling\0Aworker_init_deque_size=2048\0Aroute_table_size=16\0A\0A# Debug\0Acore_dump=1\0Acounter_folder=./counters\0A", arts.runtime_static_workers = false, arts.runtime_total_nodes = 1 : i64, arts.runtime_total_workers = 64 : i64, dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %alloc = memref.alloc() {arts.id = 30 : i64, arts.memref = #arts.memref_metadata<rank = 2 : i64, allocationId = "2mm.c:113:21", totalAccesses = 4 : i64, readCount = 2 : i64, writeCount = 2 : i64, allAccessesAffine = true, hasNonAffineAccesses = false, memoryFootprint = 524288 : i64, firstUseId = 30 : i64, lastUseId = 31 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = true, hasLoopCarriedDeps = true, reuseDistance = 1 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [3, 3], estimatedAccessBytes = 32 : i64>} : memref<256x256xf64>
    %alloc_3 = memref.alloc() {arts.id = 32 : i64, arts.memref = #arts.memref_metadata<rank = 2 : i64, allocationId = "2mm.c:114:19", totalAccesses = 2 : i64, readCount = 1 : i64, writeCount = 1 : i64, allAccessesAffine = true, hasNonAffineAccesses = false, memoryFootprint = 524288 : i64, firstUseId = 32 : i64, lastUseId = 33 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = true, hasLoopCarriedDeps = false, reuseDistance = 4 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [3, 3], estimatedAccessBytes = 16 : i64>} : memref<256x256xf64>
    ...
    %alloc_6 = memref.alloc() {arts.id = 38 : i64, arts.memref = #arts.memref_metadata<rank = 2 : i64, allocationId = "2mm.c:117:19", totalAccesses = 6 : i64, readCount = 3 : i64, writeCount = 3 : i64, allAccessesAffine = true, hasNonAffineAccesses = false, memoryFootprint = 524288 : i64, firstUseId = 38 : i64, lastUseId = 39 : i64, hasUniformAccess = false, dominantAccessPattern = 0 : i64, accessedInParallelLoop = true, hasLoopCarriedDeps = true, reuseDistance = 1 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [3, 3], estimatedAccessBytes = 48 : i64>} : memref<256x256xf64>
    affine.for %arg2 = 0 to 256 {
      ...
      affine.for %arg3 = 0 to 256 {
        ...
        affine.store %14, %alloc_3[%arg2, %arg3] : memref<256x256xf64>
    ...
    affine.for %arg2 = 0 to 256 {
      ...
      affine.for %arg3 = 0 to 256 {
        ...
        %14 = arith.mulf %10, %13 : f64
        %15 = arith.divf %14, %cst : f64
        affine.store %15, %alloc_6[%arg2, %arg3] : memref<256x256xf64>
    ...
    affine.for %arg2 = 0 to 256 {
      affine.for %arg3 = 0 to 256 {
        affine.store %cst_2, %alloc[%arg2, %arg3] : memref<256x256xf64>
        affine.for %arg4 = 0 to 256 {
          %9 = affine.load %alloc_3[%arg2, %arg4] : memref<256x256xf64>
          %10 = arith.mulf %9, %cst_0 : f64
          %11 = affine.load %alloc_4[%arg4, %arg3] : memref<256x256xf64>
          %12 = arith.mulf %10, %11 : f64
          %13 = affine.load %alloc[%arg2, %arg3] : memref<256x256xf64>
          %14 = arith.addf %13, %12 : f64
          affine.store %14, %alloc[%arg2, %arg3] : memref<256x256xf64>
    ...
    } {arts.id = 105 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = true, hasReductions = false, tripCount = 256 : i64, nestingLevel = 0 : i64, hasInterIterationDeps = false, memrefsWithLoopCarriedDeps = 0 : i64, parallelClassification = 2 : i64, locationKey = "2mm.c:137:3">}
    affine.for %arg2 = 0 to 256 {
      affine.for %arg3 = 0 to 256 {
        %9 = affine.load %alloc_6[%arg2, %arg3] : memref<256x256xf64>
        %10 = arith.mulf %9, %cst_1 : f64
        affine.store %10, %alloc_6[%arg2, %arg3] : memref<256x256xf64>
        affine.for %arg4 = 0 to 256 {
          %11 = affine.load %alloc[%arg2, %arg4] : memref<256x256xf64>
          %12 = affine.load %alloc_5[%arg4, %arg3] : memref<256x256xf64>
          %13 = arith.mulf %11, %12 : f64
          %14 = affine.load %alloc_6[%arg2, %arg3] : memref<256x256xf64>
    ...
    } {arts.id = 120 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = true, hasReductions = false, tripCount = 256 : i64, nestingLevel = 0 : i64, hasInterIterationDeps = false, memrefsWithLoopCarriedDeps = 0 : i64, parallelClassification = 2 : i64, locationKey = "2mm.c:137:3">}
    ...
    %7 = affine.for %arg2 = 0 to 256 iter_args(%arg3 = %cst_2) -> (f64) {
      %9 = affine.load %alloc_6[%arg2, %arg2] : memref<256x256xf64>
      %10 = arith.addf %arg3, %9 : f64
      affine.yield %10 : f64
    } {arts.id = 122 : i64, arts.loop = #arts.loop_metadata<potentiallyParallel = true, hasReductions = true, reductionKinds = ["add"], tripCount = 256 : i64, nestingLevel = 0 : i64, hasInterIterationDeps = false, memrefsWithLoopCarriedDeps = 0 : i64, parallelClassification = 2 : i64, locationKey = "2mm.c:144:21">}
