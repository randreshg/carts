    ...
    scf.if %14 {
      ...
      scf.for %arg0 = %c0 to %c16 step %c1 {
        scf.for %arg1 = %c0 to %c1024 step %c1 {
          %21 = memref.load %alloca_12[] : memref<i32>
          %22 = arith.remsi %21, %c113_i32 : i32
          %23 = arith.sitofp %22 : i32 to f32
          %24 = arith.subf %23, %cst_1 : f32
          ...
          memref.store %25, %28[%27, %arg1] : memref<?x?xf32>
          %29 = memref.load %alloca_12[] : memref<i32>
          %30 = arith.addi %29, %c1_i32 : i32
          memref.store %30, %alloca_12[] : memref<i32>
      ...
      scf.for %arg0 = %c0 to %c1024 step %c1 {
        %21 = arts.db_ref %ptr_7[%c0] : memref<?xmemref<?xf32>> -> memref<?xf32>
        memref.store %cst_3, %21[%arg0] : memref<?xf32>
        %22 = arts.db_ref %ptr_9[%c0] : memref<?xmemref<?xf32>> -> memref<?xf32>
        memref.store %cst_4, %22[%arg0] : memref<?xf32>
      ...
      %17 = arts.epoch attributes {arts.pattern_revision = 2 : i64, arts.plan.async_strategy = "blocking", arts.plan.cost.expected_local_work = 0 : i64, arts.plan.cost.relaunch_amortization = 0 : i64, arts.plan.cost.scheduler_overhead = 300 : i64, arts.plan.cost.slice_widening_pressure = 0 : i64, arts.plan.iteration_topology = "owner_strip", arts.plan.kernel_family = "uniform", arts.plan.repetition_structure = "none", depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32} {
        scf.for %arg0 = %c0 to %c2 step %c1 {
          %21 = arith.muli %arg0, %c8 : index
          %22 = arith.cmpi uge, %21, %c16 : index
          %23 = arith.subi %c16, %21 : index
          %24 = arith.select %22, %c0, %23 : index
          %25 = arith.minui %24, %c8 : index
          %26 = arith.cmpi ugt, %25, %c0 : index
          scf.if %26 {
            %27 = arith.divui %21, %c8 : index
            %28 = arith.cmpi ugt, %27, %c1 : index
            %29 = arith.select %28, %c0, %27 : index
            %guid_13, %ptr_14 = arts.db_acquire[<inout>] (%guid : memref<?xi64>, %ptr : memref<?xmemref<?x?xf32>>) partitioning(<block>, offsets[%21], sizes[%c8]), offsets[%29], sizes[%c1] element_offsets[%21] element_sizes[%c8] {arts.pattern_revision = 2 : i64, depPattern = #arts.dep_pattern<uniform>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<uniform>, distribution_version = 1 : i32, preserve_dep_edge = #arts.preserve_dep_edge, stencil_block_shape = [8, 1024], stencil_owner_dims = [0]} -> (memref<?xi64>, memref<?xmemref<?x?xf32>>)
            ...
            %30 = arith.addi %21, %25 : index
            %31 = arith.cmpi uge, %21, %c1 : index
            %32 = arith.subi %21, %c1 : index
            %33 = arith.select %31, %32, %c0 : index
            %34 = arith.addi %30, %c1 : index
            %35 = arith.minui %34, %c1024 : index
            %36 = arith.cmpi uge, %35, %33 : index
            %37 = arith.subi %35, %33 : index
            %38 = arith.select %36, %37, %c0 : index
            %39 = arith.maxui %38, %c1 : index
            %40 = arith.divui %33, %c1024 : index
            %41 = arith.addi %33, %39 : index
            %42 = arith.subi %41, %c1 : index
            %43 = arith.divui %42, %c1024 : index
            %44 = arith.cmpi ugt, %40, %c0 : index
            %45 = arith.select %44, %43, %c0 : index
            %46 = arith.subi %45, %40 : index
            ...
            ^bb0(%arg1: memref<?xmemref<?x?xf32>>, %arg2: memref<?xmemref<?xf32>>, %arg3: memref<?xmemref<?xf32>>):
              %50 = "polygeist.undef"() : () -> f32
              %51 = arith.subi %c0, %21 : index
              %52 = arith.cmpi slt, %51, %c0 : index
              %53 = arith.select %52, %c0, %51 : index
              %54 = arith.cmpi slt, %23, %c0 : index
              ...
              scf.for %arg4 = %53 to %56 step %c1 {
                ...
                scf.for %arg5 = %c0 to %c1024 step %c1 {
                  ...
                  %65 = memref.load %64[%arg4, %arg5] : memref<?x?xf32>
                  %66 = arith.subf %65, %58 : f32
                  %67 = arith.mulf %66, %63 : f32
                  %68 = arts.db_ref %arg2[%c0] : memref<?xmemref<?xf32>> -> memref<?xf32>
                  %69 = memref.load %68[%arg5] : memref<?xf32>
                  %70 = arith.mulf %67, %69 : f32
                  %71 = arts.db_ref %arg3[%c0] : memref<?xmemref<?xf32>> -> memref<?xf32>
                  %72 = memref.load %71[%arg5] : memref<?xf32>
                  %73 = arith.addf %70, %72 : f32
                  memref.store %73, %64[%arg4, %arg5] : memref<?x?xf32>
      ...
      %18 = polygeist.pointer2memref %1 : !llvm.ptr to memref<?xi8>
      func.call @carts_phase_timer_start(%18, %8) : (memref<?xi8>, memref<?xi8>) -> ()
      memref.store %cst_5, %alloca[] : memref<f64>
      scf.for %arg0 = %c0 to %c16 step %c1 {
        %21 = arith.divui %arg0, %c8 : index
        %22 = arith.remui %arg0, %c8 : index
        %23 = arts.db_ref %ptr[%21] : memref<?xmemref<?x?xf32>> -> memref<?x?xf32>
        %24 = memref.load %23[%22, %arg0] : memref<?x?xf32>
      ...
      func.call @carts_bench_checksum_d(%19) : (f64) -> ()
      func.call @carts_phase_timer_stop(%18) : (memref<?xi8>) -> ()
      %20 = polygeist.pointer2memref %0 : !llvm.ptr to memref<?xi8>
      func.call @carts_phase_timer_start(%20, %8) : (memref<?xi8>, memref<?xi8>) -> ()
