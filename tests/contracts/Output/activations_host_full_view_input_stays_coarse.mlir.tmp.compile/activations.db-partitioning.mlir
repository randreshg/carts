      ...
      scf.for %arg2 = %c0 to %c2 step %c1 {
        ...
        scf.if %103 {
          ...
          ^bb0(%arg3: memref<?xmemref<?xf32>>, %arg4: memref<?xmemref<?xf32>>, %arg5: memref<?xmemref<?xf32>>, %arg6: memref<?xmemref<?xf32>>, %arg7: memref<?xmemref<?xf32>>, %arg8: memref<?xmemref<?xf32>>, %arg9: memref<?xmemref<?xf32>>):
            ...
            %220 = arith.maxui %50, %c1_170 : index
            ...
            %228 = arith.select %176, %c0_172, %227 : index
            ...
            %265 = arith.maxui %20, %c1_200 : index
            ...
            %273 = arith.select %134, %c0_202, %272 : index
            ...
            scf.for %arg10 = %276 to %279 step %c1 {
              ...
              %296 = arith.maxui %265, %c1_209 : index
              ...
              %301 = arith.subi %298, %273 : index
              %302 = arts.db_ref %arg4[%c0_201] : memref<?xmemref<?xf32>> -> memref<?xf32>
              ...
              %305 = arith.maxui %247, %c1_213 : index
              ...
              %310 = arith.subi %307, %255 : index
              %311 = arts.db_ref %arg5[%c0_189] : memref<?xmemref<?xf32>> -> memref<?xf32>
        ...
        scf.if %103 {
          ...
          ^bb0(%arg3: memref<?xmemref<?xf32>>, %arg4: memref<?xmemref<?xf32>>, %arg5: memref<?xmemref<?xf32>>, %arg6: memref<?xmemref<?xf32>>, %arg7: memref<?xmemref<?xf32>>, %arg8: memref<?xmemref<?xf32>>, %arg9: memref<?xmemref<?xf32>>):
            ...
            scf.for %arg10 = %276 to %279 step %c1 {
              ...
              %c1_206 = arith.constant 1 : index
              %291 = arith.maxui %220, %c1_206 : index
              %c0_207 = arith.constant 0 : index
              %c1_208 = arith.constant 1 : index
              %c-1 = arith.constant -1 : index
              ...
              %296 = arith.subi %293, %228 : index
              %297 = arts.db_ref %arg7[%c0_171] : memref<?xmemref<?xf32>> -> memref<?xf32>
