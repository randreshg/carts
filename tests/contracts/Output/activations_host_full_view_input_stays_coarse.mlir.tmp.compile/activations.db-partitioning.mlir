      ...
      scf.for %arg2 = %c0 to %c2 step %c1 {
        ...
        scf.if %103 {
          ...
          ^bb0(%arg3: memref<?xmemref<?xf32>>, %arg4: memref<?xmemref<?xf32>>, %arg5: memref<?xmemref<?xf32>>, %arg6: memref<?xmemref<?xf32>>, %arg7: memref<?xmemref<?xf32>>, %arg8: memref<?xmemref<?xf32>>, %arg9: memref<?xmemref<?xf32>>):
            ...
            %211 = arith.maxui %50, %c1_164 : index
            ...
            %219 = arith.select %176, %c0_166, %218 : index
            ...
            %229 = arith.maxui %20, %c1_176 : index
            ...
            %237 = arith.select %134, %c0_178, %236 : index
            %c1_182 = arith.constant 1 : index
            %c0_183 = arith.constant 0 : index
            %238 = arith.maxui %70, %c1_182 : index
            ...
            %246 = arith.select %204, %c0_184, %245 : index
            ...
            scf.for %arg10 = %276 to %279 step %c1 {
              ...
              %296 = arith.maxui %229, %c1_209 : index
              ...
              %301 = arith.subi %298, %237 : index
              %302 = arts.db_ref %arg4[%c0_177] : memref<?xmemref<?xf32>> -> memref<?xf32>
        ...
        scf.if %103 {
          ...
          ^bb0(%arg3: memref<?xmemref<?xf32>>, %arg4: memref<?xmemref<?xf32>>, %arg5: memref<?xmemref<?xf32>>, %arg6: memref<?xmemref<?xf32>>, %arg7: memref<?xmemref<?xf32>>, %arg8: memref<?xmemref<?xf32>>, %arg9: memref<?xmemref<?xf32>>):
            ...
            scf.for %arg10 = %276 to %279 step %c1 {
              ...
              %c1_206 = arith.constant 1 : index
              %291 = arith.maxui %211, %c1_206 : index
              %c0_207 = arith.constant 0 : index
              %c1_208 = arith.constant 1 : index
              %c-1 = arith.constant -1 : index
              ...
              %296 = arith.subi %293, %219 : index
              %297 = arts.db_ref %arg7[%c0_165] : memref<?xmemref<?xf32>> -> memref<?xf32>
        ...
        scf.if %103 {
          ...
          ^bb0(%arg3: memref<?xmemref<?xf32>>, %arg4: memref<?xmemref<?xf32>>, %arg5: memref<?xmemref<?xf32>>, %arg6: memref<?xmemref<?xf32>>, %arg7: memref<?xmemref<?xf32>>, %arg8: memref<?xmemref<?xf32>>, %arg9: memref<?xmemref<?xf32>>):
            ...
            scf.for %arg10 = %276 to %279 step %c1 {
              ...
              %c1_206 = arith.constant 1 : index
              %287 = arith.maxui %238, %c1_206 : index
              %c0_207 = arith.constant 0 : index
              %c1_208 = arith.constant 1 : index
              %c-1 = arith.constant -1 : index
              ...
              %292 = arith.subi %289, %246 : index
              %293 = arts.db_ref %arg9[%c0_183] : memref<?xmemref<?xf32>> -> memref<?xf32>
