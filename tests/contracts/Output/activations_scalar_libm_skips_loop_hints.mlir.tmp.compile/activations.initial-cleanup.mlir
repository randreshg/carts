module attributes {arts.runtime_config_data = "[ARTS]\0A# Contract config for single-worker lowering checks.\0Aworker_threads=1\0A\0A# Network configuration\0Asender_threads=0\0Areceiver_threads=0\0Aport_count=1\0A\0A# Launcher configuration\0Alauncher=local\0Amaster_node=localhost\0Anode_count=1\0Anodes=localhost\0Adefault_ports=34739\0A\0A# Scheduling\0Aworker_init_deque_size=2048\0Aroute_table_size=16\0A\0A# Debug\0Acore_dump=1\0Acounter_folder=./counters\0A", arts.runtime_static_workers = false, arts.runtime_total_nodes = 1 : i64, arts.runtime_total_workers = 1 : i64, dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %alloc = memref.alloc() {arts.id = 41 : i64, arts.memref = #arts.memref_metadata<rank = 1 : i64, allocationId = "activations.c:171:21", totalAccesses = 2 : i64, readCount = 1 : i64, writeCount = 1 : i64, allAccessesAffine = false, hasNonAffineAccesses = true, memoryFootprint = 4096 : i64, firstUseId = 41 : i64, lastUseId = 294 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = false, hasLoopCarriedDeps = false, reuseDistance = 10 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [4], estimatedAccessBytes = 8 : i64>, arts.metadata_provenance = "exact"} : memref<1024xf32>
    %alloc_18 = memref.alloc() {arts.id = 42 : i64, arts.memref = #arts.memref_metadata<rank = 1 : i64, allocationId = "activations.c:172:22", totalAccesses = 2 : i64, readCount = 1 : i64, writeCount = 1 : i64, allAccessesAffine = false, hasNonAffineAccesses = true, memoryFootprint = 4096 : i64, firstUseId = 42 : i64, lastUseId = 295 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = false, hasLoopCarriedDeps = false, reuseDistance = 11 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [4], estimatedAccessBytes = 8 : i64>, arts.metadata_provenance = "exact"} : memref<1024xf32>
    %alloc_19 = memref.alloc() {arts.id = 43 : i64, arts.memref = #arts.memref_metadata<rank = 1 : i64, allocationId = "activations.c:173:22", totalAccesses = 2 : i64, readCount = 1 : i64, writeCount = 1 : i64, allAccessesAffine = false, hasNonAffineAccesses = true, memoryFootprint = 4096 : i64, firstUseId = 43 : i64, lastUseId = 296 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = false, hasLoopCarriedDeps = false, reuseDistance = 12 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [4], estimatedAccessBytes = 8 : i64>, arts.metadata_provenance = "exact"} : memref<1024xf32>
    %alloc_20 = memref.alloc() {arts.id = 44 : i64, arts.memref = #arts.memref_metadata<rank = 1 : i64, allocationId = "activations.c:174:21", totalAccesses = 2 : i64, readCount = 1 : i64, writeCount = 1 : i64, allAccessesAffine = false, hasNonAffineAccesses = true, memoryFootprint = 4096 : i64, firstUseId = 44 : i64, lastUseId = 297 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = false, hasLoopCarriedDeps = false, reuseDistance = 13 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [4], estimatedAccessBytes = 8 : i64>, arts.metadata_provenance = "exact"} : memref<1024xf32>
    %alloc_21 = memref.alloc() {arts.id = 45 : i64, arts.memref = #arts.memref_metadata<rank = 1 : i64, allocationId = "activations.c:175:26", totalAccesses = 2 : i64, readCount = 1 : i64, writeCount = 1 : i64, allAccessesAffine = false, hasNonAffineAccesses = true, memoryFootprint = 4096 : i64, firstUseId = 45 : i64, lastUseId = 298 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = false, hasLoopCarriedDeps = false, reuseDistance = 14 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [4], estimatedAccessBytes = 8 : i64>, arts.metadata_provenance = "exact"} : memref<1024xf32>
    %alloc_22 = memref.alloc() {arts.id = 46 : i64, arts.memref = #arts.memref_metadata<rank = 1 : i64, allocationId = "activations.c:176:24", totalAccesses = 2 : i64, readCount = 1 : i64, writeCount = 1 : i64, allAccessesAffine = false, hasNonAffineAccesses = true, memoryFootprint = 4096 : i64, firstUseId = 46 : i64, lastUseId = 299 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = false, hasLoopCarriedDeps = false, reuseDistance = 15 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [4], estimatedAccessBytes = 8 : i64>, arts.metadata_provenance = "exact"} : memref<1024xf32>
    %alloc_23 = memref.alloc() {arts.id = 47 : i64, arts.memref = #arts.memref_metadata<rank = 1 : i64, allocationId = "activations.c:177:21", totalAccesses = 2 : i64, readCount = 1 : i64, writeCount = 1 : i64, allAccessesAffine = false, hasNonAffineAccesses = true, memoryFootprint = 4096 : i64, firstUseId = 47 : i64, lastUseId = 300 : i64, hasUniformAccess = true, dominantAccessPattern = 0 : i64, accessedInParallelLoop = false, hasLoopCarriedDeps = false, reuseDistance = 16 : i64, hasGoodSpatialLocality = true, dimAccessPatterns = [4], estimatedAccessBytes = 8 : i64>, arts.metadata_provenance = "exact"} : memref<1024xf32>
    ...
    omp.parallel {
      omp.wsloop {
        omp.loop_nest (%arg2) : index = (%c0) to (%c1024) step (%c1) {
          ...
          memref.store %33, %alloc[%arg2] : memref<1024xf32>
          omp.yield
        }
      }
      omp.terminator
      ...
      omp.wsloop {
        omp.loop_nest (%arg2) : index = (%c0) to (%c1024) step (%c1) {
          ...
          %33 = scf.if %32 -> (f32) {
            ...
            %34 = arith.mulf %31, %cst_6 : f32
            scf.yield %34 : f32
          }
          memref.store %33, %alloc_18[%arg2] : memref<1024xf32>
          omp.yield
        }
      }
      omp.terminator
    ...
    omp.parallel {
      omp.wsloop {
        omp.loop_nest (%arg2) : index = (%c0) to (%c1024) step (%c1) {
          ...
          memref.store %35, %alloc_19[%arg2] : memref<1024xf32>
          omp.yield
        }
      }
      omp.terminator
    ...
    omp.parallel {
      omp.wsloop {
        omp.loop_nest (%arg2) : index = (%c0) to (%c1024) step (%c1) {
          ...
          memref.store %40, %alloc_20[%arg2] : memref<1024xf32>
          omp.yield
        }
      }
      omp.terminator
    ...
    omp.parallel {
      omp.wsloop {
        omp.loop_nest (%arg2) : index = (%c0) to (%c1024) step (%c1) {
          ...
          memref.store %36, %alloc_21[%arg2] : memref<1024xf32>
          omp.yield
        }
      }
      omp.terminator
    ...
    omp.parallel {
      omp.wsloop {
        omp.loop_nest (%arg2) : index = (%c0) to (%c1024) step (%c1) {
          ...
          %34 = arith.addf %33, %cst_5 : f32
          %35 = arith.divf %cst_5, %34 : f32
          memref.store %35, %alloc_22[%arg2] : memref<1024xf32>
          omp.yield
        }
      }
      omp.terminator
    ...
    omp.parallel {
      omp.wsloop {
        omp.loop_nest (%arg2) : index = (%c0) to (%c1024) step (%c1) {
          ...
          memref.store %32, %alloc_23[%arg2] : memref<1024xf32>
          omp.yield
        }
      }
      omp.terminator
    ...
    scf.for %arg2 = %c0 to %c1024 step %c1 {
      %27 = memref.load %alloc[%arg2] : memref<1024xf32>
    ...
    scf.for %arg2 = %c0 to %c1024 step %c1 {
      %27 = memref.load %alloc_18[%arg2] : memref<1024xf32>
      %28 = arith.extf %27 : f32 to f64
      %29 = math.absf %28 : f64
    ...
    scf.for %arg2 = %c0 to %c1024 step %c1 {
      %27 = memref.load %alloc_19[%arg2] : memref<1024xf32>
      %28 = arith.extf %27 : f32 to f64
      %29 = math.absf %28 : f64
    ...
    scf.for %arg2 = %c0 to %c1024 step %c1 {
      %27 = memref.load %alloc_20[%arg2] : memref<1024xf32>
      %28 = arith.extf %27 : f32 to f64
      %29 = math.absf %28 : f64
    ...
    scf.for %arg2 = %c0 to %c1024 step %c1 {
      %27 = memref.load %alloc_21[%arg2] : memref<1024xf32>
      %28 = arith.extf %27 : f32 to f64
      %29 = math.absf %28 : f64
    ...
    scf.for %arg2 = %c0 to %c1024 step %c1 {
      %27 = memref.load %alloc_22[%arg2] : memref<1024xf32>
      %28 = arith.extf %27 : f32 to f64
      %29 = math.absf %28 : f64
    ...
    scf.for %arg2 = %c0 to %c1024 step %c1 {
      %27 = memref.load %alloc_23[%arg2] : memref<1024xf32>
      %28 = arith.extf %27 : f32 to f64
      %29 = math.absf %28 : f64
    ...
    memref.dealloc %alloc {arts.id = 294 : i64} : memref<1024xf32>
    memref.dealloc %alloc_18 {arts.id = 295 : i64} : memref<1024xf32>
    memref.dealloc %alloc_19 {arts.id = 296 : i64} : memref<1024xf32>
    memref.dealloc %alloc_20 {arts.id = 297 : i64} : memref<1024xf32>
    memref.dealloc %alloc_21 {arts.id = 298 : i64} : memref<1024xf32>
    memref.dealloc %alloc_22 {arts.id = 299 : i64} : memref<1024xf32>
    memref.dealloc %alloc_23 {arts.id = 300 : i64} : memref<1024xf32>
