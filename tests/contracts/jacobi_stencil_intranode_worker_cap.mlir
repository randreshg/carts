...
// CHECK: arts.epoch attributes {arts.pattern_revision = 1 : i64, depPattern = #arts.dep_pattern<jacobi_alternating_buffers>, distribution_kind = #arts.distribution_kind<block>, distribution_pattern = #arts.distribution_pattern<stencil>
