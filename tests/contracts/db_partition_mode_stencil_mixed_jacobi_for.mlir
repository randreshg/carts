// RUN: %carts-compile %s --O3 --arts-config %S/../../docker/arts-docker-2node.cfg --stop-at concurrency-opt | %FileCheck %s
...
// CHECK: arts.db_acquire[<in>] (%[[SGUID]] : memref<?xi64>, %[[SPTR]] : memref<?xmemref<?x?xf64>>) partitioning(<block>)
