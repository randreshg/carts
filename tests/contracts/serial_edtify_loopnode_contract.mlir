...
// RUN: %carts-compile %s --O3 --arts-config %S/../../docker/arts-docker-2node.cfg --serial-edtify --distributed-db-ownership --stop-at concurrency-opt --debug-only=serial_edtify,distributed_db_ownership 2>&1 | %FileCheck %s --check-prefix=DIST
