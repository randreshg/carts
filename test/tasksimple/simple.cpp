...
carts-opt simple.mlir --lower-affine --cse --polygeist-mem2reg --canonicalize --loop-invariant-code-motion --canonicalize --arts-inliner --convert-openmp-to-arts --edt --edt-invariant-code-motion --canonicalize --create-dbs --db --cse -debug-only=db,db-analysis,db-alias-analysis,db-dataflow-analysis,db-info &> simple-arts.mlir

carts-opt simple.mlir --lower-affine --cse --polygeist-mem2reg --canonicalize --loop-invariant-code-motion --canonicalize --arts-inliner --convert-openmp-to-arts --edt --edt-invariant-code-motion --canonicalize --create-dbs --db --cse --polygeist-mem2reg --edt-pointer-rematerialization --create-epochs --convert-arts-to-llvm --cse -debug-only=convert-arts-to-llvm,arts-codegen &> simple-arts.mlir
