...
/// the writer's iteration domain, an unsupported
/// (non-load/store/dealloc/window) use of the MU root, accesses spanning zero
/// or multiple CUs, or an in-place (read+write) access in the CU.
