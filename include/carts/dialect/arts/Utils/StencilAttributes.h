...
#ifndef CARTS_DIALECT_ARTS_UTILS_STENCILATTRIBUTES_H
#define CARTS_DIALECT_ARTS_UTILS_STENCILATTRIBUTES_H
...
#endif // CARTS_DIALECT_ARTS_UTILS_STENCILATTRIBUTES_H
