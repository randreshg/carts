...
/// Types
using EDTValue = llvm::Value;
using EDTValueSet = llvm::SetVector<EDTValue *>;
using EDTCallBase = llvm::CallBase;
using EDTSet = llvm::SetVector<EDT *>;
using EDTFunction = llvm::Function;
using EDTFunctionSet = llvm::SetVector<EDTFunction *>;
using DataBlockSet = llvm::SetVector<DataBlock *>;
using BlockSequence = llvm::SmallVector<llvm::BasicBlock *, 0>;
