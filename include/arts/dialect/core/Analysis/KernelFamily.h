#ifndef ARTS_DIALECT_CORE_ANALYSIS_KERNELFAMILY_H
#define ARTS_DIALECT_CORE_ANALYSIS_KERNELFAMILY_H
...
inline llvm::StringRef repetitionStructureToString(RepetitionStructure rep) {
  switch (rep) {
