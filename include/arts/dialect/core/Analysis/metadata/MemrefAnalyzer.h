...
#ifndef ARTS_DIALECT_CORE_ANALYSIS_METADATA_MEMREFANALYZER_H
#define ARTS_DIALECT_CORE_ANALYSIS_METADATA_MEMREFANALYZER_H
...
private:
  ...
  std::pair<uint64_t, uint64_t> countAccessTypes(Value memref,
                                                 Operation *scopeOp);
  std::pair<ArtsId, ArtsId> computeLifetime(Value memref, Operation *scopeOp);
...
#endif // ARTS_DIALECT_CORE_ANALYSIS_METADATA_MEMREFANALYZER_H
