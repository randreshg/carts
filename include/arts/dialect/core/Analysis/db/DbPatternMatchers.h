...
#ifndef ARTS_DIALECT_CORE_ANALYSIS_DB_DBPATTERNMATCHERS_H
#define ARTS_DIALECT_CORE_ANALYSIS_DB_DBPATTERNMATCHERS_H
...
#endif // ARTS_DIALECT_CORE_ANALYSIS_DB_DBPATTERNMATCHERS_H
