...
#ifndef ARTS_DIALECT_CORE_ANALYSIS_INFORMATIONCACHE_H
#define ARTS_DIALECT_CORE_ANALYSIS_INFORMATIONCACHE_H
...
#endif // ARTS_DIALECT_CORE_ANALYSIS_INFORMATIONCACHE_H
