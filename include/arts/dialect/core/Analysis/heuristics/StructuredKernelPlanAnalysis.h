...
#ifndef ARTS_DIALECT_CORE_ANALYSIS_HEURISTICS_STRUCTUREDKERNELPLANANALYSIS_H
#define ARTS_DIALECT_CORE_ANALYSIS_HEURISTICS_STRUCTUREDKERNELPLANANALYSIS_H
...
private:
  ...
  IterationTopology selectTopology(KernelFamily family, bool isInternode) const;
...
#endif // ARTS_DIALECT_CORE_ANALYSIS_HEURISTICS_STRUCTUREDKERNELPLANANALYSIS_H
