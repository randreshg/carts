...
#ifndef ARTS_DIALECT_CORE_ANALYSIS_GRAPHS_DB_DBBLOCKINFOCOMPUTER_H
#define ARTS_DIALECT_CORE_ANALYSIS_GRAPHS_DB_DBBLOCKINFOCOMPUTER_H
...
/// DbBlockInfoComputer -- computes block offset and size for partition
