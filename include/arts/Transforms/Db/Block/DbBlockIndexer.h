...
public:
  ...
  /// Block mode subindex handling: applies div/mod to the subindex index
  /// using blockSizes/startBlocks for proper block-relative addressing.
  bool handleSubIndexOp(Operation *op, Value dbPtr, Type elementType,
                        ArtsCodegen &AC,
