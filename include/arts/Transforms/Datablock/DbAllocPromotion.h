///==========================================================================///
/// File: DbAllocPromotion.h
///
/// Allocation Promotion Transformation - transforms coarse-grained allocations
/// to fine-grained (chunked or element-wise) allocations.
///==========================================================================///

#ifndef ARTS_TRANSFORMS_DATABLOCK_DBALLOCPROMOTION_H
#define ARTS_TRANSFORMS_DATABLOCK_DBALLOCPROMOTION_H
...
private:
  ...
  struct AcquireViewMap {
    ...
    /// Critical for chunked mode: EDT block args represent already-localized
    /// views
...
#endif // ARTS_TRANSFORMS_DATABLOCK_DBALLOCPROMOTION_H
