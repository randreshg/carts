...
///===--------------------------------------------------------------------===///
/// ArtsMetadataManager - Facade for metadata management
///
...
public:
  explicit ArtsMetadataManager(MLIRContext *context)
  ...
  ArtsMetadataManager(ArtsMetadataManager &&) = delete;
  ArtsMetadataManager &operator=(ArtsMetadataManager &&) = delete;
