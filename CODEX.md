...
| `distributed-triage` | Use when a failure only appears in multinode/distributed runs (vs the `--no-distributed-db` baseline), multiple nodes, SDE/CODIR/ARTS distributed work materialization, or uneven remote work distribution. | `carts-plugin/skills/distributed-triage/SKILL.md` |
